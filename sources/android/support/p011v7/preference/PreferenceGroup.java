...
public abstract class PreferenceGroup extends Preference {
    ...
    /* renamed from: android.support.v7.preference.PreferenceGroup$OnExpandButtonClickListener */
    /* loaded from: classes.dex */
    ...
    public PreferenceGroup(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0447R.styleable.PreferenceGroup, i, i2);
        this.mOrderingAsAdded = TypedArrayUtils.getBoolean(obtainStyledAttributes, C0447R.styleable.PreferenceGroup_orderingFromXml, C0447R.styleable.PreferenceGroup_orderingFromXml, true);
        if (obtainStyledAttributes.hasValue(C0447R.styleable.PreferenceGroup_initialExpandedChildrenCount)) {
            setInitialExpandedChildrenCount(TypedArrayUtils.getInt(obtainStyledAttributes, C0447R.styleable.PreferenceGroup_initialExpandedChildrenCount, C0447R.styleable.PreferenceGroup_initialExpandedChildrenCount, Integer.MAX_VALUE));
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: android.support.v7.preference.PreferenceGroup$SavedState */
    /* loaded from: classes.dex */
