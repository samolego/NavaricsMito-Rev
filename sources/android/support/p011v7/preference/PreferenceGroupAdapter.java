...
import android.support.p011v7.util.DiffUtil;
...
public class PreferenceGroupAdapter extends RecyclerView.Adapter<PreferenceViewHolder> implements Preference.OnPreferenceChangeInternalListener, PreferenceGroup.PreferencePositionCallback {
    ...
    void syncMyPreferences() {
        ...
        if (preferenceManager != null && preferenceManager.getPreferenceComparisonCallback() != null) {
            ...
            DiffUtil.calculateDiff(new DiffUtil.Callback() { // from class: android.support.v7.preference.PreferenceGroupAdapter.2
                @Override // android.support.p011v7.util.DiffUtil.Callback
    ...
    @Override // android.support.p011v7.preference.Preference.OnPreferenceChangeInternalListener
    ...
    public PreferenceViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        TypedArray obtainStyledAttributes = viewGroup.getContext().obtainStyledAttributes((AttributeSet) null, C0447R.styleable.BackgroundStyle);
        Drawable drawable = obtainStyledAttributes.getDrawable(C0447R.styleable.BackgroundStyle_android_selectableItemBackground);
        if (drawable == null) {
    ...
    @Override // android.support.p011v7.preference.PreferenceGroup.PreferencePositionCallback
