...
public class DropDownPreference extends ListPreference {
    ...
    public DropDownPreference(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0447R.attr.dropdownPreferenceStyle);
    }
    ...
    @Override // android.support.p011v7.preference.DialogPreference, android.support.p011v7.preference.Preference
    public void onClick() {
        this.mSpinner.performClick();
    }

    @Override // android.support.p011v7.preference.ListPreference
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        this.mSpinner = (Spinner) preferenceViewHolder.itemView.findViewById(C0447R.C0449id.spinner);
