...
import android.support.p011v7.widget.ForwardingListener;
...
public class ActionMenuItemView extends AppCompatTextView implements MenuView.ItemView, ActionMenuView.ActionMenuChildView, View.OnClickListener {
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0425R.styleable.ActionMenuItemView, i, 0);
        this.mMinWidth = obtainStyledAttributes.getDimensionPixelSize(C0425R.styleable.ActionMenuItemView_android_minWidth, 0);
    ...
    @Override // android.support.p011v7.widget.AppCompatTextView, android.widget.TextView, android.view.View
