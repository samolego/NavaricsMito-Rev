...
import android.support.p011v7.widget.LinearLayoutCompat;
...
public class AlertController {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0425R.attr.alertDialogCenterButtons, typedValue, true);
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C0425R.styleable.AlertDialog, C0425R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(C0425R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(C0425R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(C0425R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(C0425R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(C0425R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(C0425R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = obtainStyledAttributes.getBoolean(C0425R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = obtainStyledAttributes.getDimensionPixelSize(C0425R.styleable.AlertDialog_buttonIconDimen, 0);
    ...
    private void setupView() {
        ...
        View findViewById2;
        View findViewById3 = this.mWindow.findViewById(C0425R.C0427id.parentPanel);
        View findViewById4 = findViewById3.findViewById(C0425R.C0427id.topPanel);
        View findViewById5 = findViewById3.findViewById(C0425R.C0427id.contentPanel);
        View findViewById6 = findViewById3.findViewById(C0425R.C0427id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById3.findViewById(C0425R.C0427id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById7 = viewGroup.findViewById(C0425R.C0427id.topPanel);
        View findViewById8 = viewGroup.findViewById(C0425R.C0427id.contentPanel);
        View findViewById9 = viewGroup.findViewById(C0425R.C0427id.buttonPanel);
        ...
        if (!z3 && resolvePanel2 != null && (findViewById2 = resolvePanel2.findViewById(C0425R.C0427id.textSpacerNoButtons)) != null) {
        ...
        if (z2) {
            ...
            if (this.mMessage != null || this.mListView != null) {
                view = resolvePanel.findViewById(C0425R.C0427id.titleDividerNoCustom);
            }
            if (view != null) {
                view.setVisibility(0);
            }
        } else if (resolvePanel2 != null && (findViewById = resolvePanel2.findViewById(C0425R.C0427id.textSpacerNoTitle)) != null) {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        final View findViewById = this.mWindow.findViewById(C0425R.C0427id.scrollIndicatorUp);
        View findViewById2 = this.mWindow.findViewById(C0425R.C0427id.scrollIndicatorDown);
        ...
        if (this.mMessage != null) {
            this.mScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() { // from class: android.support.v7.app.AlertController.2
                @Override // android.support.p008v4.widget.NestedScrollView.OnScrollChangeListener
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0425R.C0427id.custom);
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0425R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = obtainStyledAttributes.getDimensionPixelOffset(C0425R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = obtainStyledAttributes.getDimensionPixelOffset(C0425R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
