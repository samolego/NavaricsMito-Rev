...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    @Override // android.support.p011v7.view.menu.MenuView
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    ...
    /* JADX WARN: Removed duplicated region for block: B:138:0x0240 A[LOOP:5: B:138:0x0240->B:143:0x025f, LOOP_START, PHI: r13 
      PHI: (r13v4 int) = (r13v3 int), (r13v5 int) binds: [B:137:0x023e, B:143:0x025f] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    private void onMeasureExactFormat(int r30, int r31) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p011v7.widget.ActionMenuView.onMeasureExactFormat(int, int):void");
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // android.support.p011v7.widget.LinearLayoutCompat, android.view.ViewGroup
    ...
    @Override // android.support.p011v7.view.menu.MenuBuilder.ItemInvoker
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
