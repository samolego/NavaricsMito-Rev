...
import android.support.p008v4.widget.ListViewAutoScrollHelper;
...
public class DropDownListView extends ListView {
    ...
    public DropDownListView(Context context, boolean z) {
        super(context, null, C0425R.attr.dropDownListViewStyle);
    ...
    public static class GateKeeperDrawable extends DrawableWrapper {
        ...
        @Override // android.support.p011v7.graphics.drawable.DrawableWrapper, android.graphics.drawable.Drawable
    ...
    */
    public boolean onForwardedEvent(android.view.MotionEvent r8, int r9) {
        ...
        L6a:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p011v7.widget.DropDownListView.onForwardedEvent(android.view.MotionEvent, int):boolean");
    }
