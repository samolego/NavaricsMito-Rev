...
public class MultiSelectListPreference extends AbstractMultiSelectListPreference {
    ...
    public MultiSelectListPreference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0447R.styleable.MultiSelectListPreference, i, i2);
        this.mEntries = TypedArrayUtils.getTextArray(obtainStyledAttributes, C0447R.styleable.MultiSelectListPreference_entries, C0447R.styleable.MultiSelectListPreference_android_entries);
        this.mEntryValues = TypedArrayUtils.getTextArray(obtainStyledAttributes, C0447R.styleable.MultiSelectListPreference_entryValues, C0447R.styleable.MultiSelectListPreference_android_entryValues);
    ...
    @Override // android.support.p011v7.preference.internal.AbstractMultiSelectListPreference
