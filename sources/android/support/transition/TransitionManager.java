...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo12955clone = transition.mo12955clone();
        mo12955clone.setSceneRoot(sceneRoot);
        Scene currentScene = Scene.getCurrentScene(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo12955clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo12955clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo12955clone);
    }
    ...
    /* renamed from: go */
    public static void m12845go(@NonNull Scene scene) {
        changeScene(scene, sDefaultTransition);
    }

    /* renamed from: go */
    public static void m12844go(@NonNull Scene scene, @Nullable Transition transition) {
    ...
    public static void beginDelayedTransition(@NonNull ViewGroup viewGroup, @Nullable Transition transition) {
        ...
        Transition mo12955clone = transition.mo12955clone();
        sceneChangeSetup(viewGroup, mo12955clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo12955clone);
    }
