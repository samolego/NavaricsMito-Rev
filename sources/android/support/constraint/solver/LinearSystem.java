...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object obj) {
        ...
        if (obj instanceof ConstraintAnchor) {
            ...
            if (solverVariable.f77id == -1 || solverVariable.f77id > this.mVariablesID || this.mCache.mIndexedVariables[solverVariable.f77id] == null) {
                if (solverVariable.f77id != -1) {
                    solverVariable.reset();
                }
                this.mVariablesID++;
                this.mNumColumns++;
                solverVariable.f77id = this.mVariablesID;
    ...
    public SolverVariable createSlackVariable() {
        ...
        this.mVariablesID++;
        this.mNumColumns++;
        acquireSolverVariable.f77id = this.mVariablesID;
    ...
    private final int optimize(Row row, boolean z) {
        ...
        while (!z2) {
            ...
            if (row.getKey() != null) {
                this.mAlreadyTestedCandidates[row.getKey().f77id] = true;
            }
            SolverVariable pivotCandidate = row.getPivotCandidate(this, this.mAlreadyTestedCandidates);
            if (pivotCandidate != null) {
                if (this.mAlreadyTestedCandidates[pivotCandidate.f77id]) {
                    return i2;
                }
                this.mAlreadyTestedCandidates[pivotCandidate.f77id] = true;
            }
            if (pivotCandidate != null) {
                int i3 = -1;
