...
public class MaterialCardView extends CardView {
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0062R.attr.materialCardViewStyle);
    }

    public MaterialCardView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C0062R.styleable.MaterialCardView, i, C0062R.style.Widget_MaterialComponents_CardView, new int[0]);
    ...
    @Override // android.support.p011v7.widget.CardView
