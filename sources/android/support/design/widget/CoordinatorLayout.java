...
import android.support.coordinatorlayout.C0033R;
...
import android.support.p008v4.view.NestedScrollingParent2;
import android.support.p008v4.view.NestedScrollingParentHelper;
...
import android.support.p008v4.widget.DirectedAcyclicGraph;
import android.support.p008v4.widget.ViewGroupUtils;
...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public CoordinatorLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i) {
        ...
        if (i == 0) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0033R.styleable.CoordinatorLayout, 0, C0033R.style.Widget_Support_CoordinatorLayout);
        } else {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0033R.styleable.CoordinatorLayout, i, 0);
        }
    ...
    */
    ...
    @Override // android.view.ViewGroup, android.view.ViewParent, android.support.p008v4.view.NestedScrollingParent
    public boolean onStartNestedScroll(View view, View view2, int i) {
        return onStartNestedScroll(view, view2, i, 0);
    }

    @Override // android.support.p008v4.view.NestedScrollingParent2
    ...
    @Override // android.view.ViewGroup, android.support.p008v4.view.NestedScrollingParent
