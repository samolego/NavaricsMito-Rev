...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C0062R.layout.design_bottom_navigation_item, (ViewGroup) this, true);
        setBackgroundResource(C0062R.C0063drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C0062R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C0062R.C0064id.icon);
        this.smallLabel = (TextView) findViewById(C0062R.C0064id.smallLabel);
        this.largeLabel = (TextView) findViewById(C0062R.C0064id.largeLabel);
    ...
    @Override // android.view.View, android.support.p011v7.view.menu.MenuView.ItemView
