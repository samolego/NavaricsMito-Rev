...
public class LoaderManagerImpl extends LoaderManager {
    ...
    public static class LoaderInfo<D> extends MutableLiveData<D> implements Loader.OnLoadCompleteListener<D> {
        ...
        @Override // android.support.p008v4.content.Loader.OnLoadCompleteListener
    ...
    public static class LoaderViewModel extends ViewModel {
        private static final ViewModelProvider.InterfaceC0018a FACTORY = new ViewModelProvider.InterfaceC0018a() { // from class: android.support.v4.app.LoaderManagerImpl.LoaderViewModel.1
            @Override // android.arch.lifecycle.ViewModelProvider.InterfaceC0018a
            @NonNull
        ...
        static LoaderViewModel getInstance(ViewModelStore viewModelStore) {
            return (LoaderViewModel) new ViewModelProvider(viewModelStore, FACTORY).m12852a(LoaderViewModel.class);
        }
    ...
    @Override // android.support.p008v4.app.LoaderManager
    @NonNull
    @MainThread
