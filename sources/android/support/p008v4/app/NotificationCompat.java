...
import android.support.p008v4.app.Person;
...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0023R.dimen.compat_notification_large_icon_max_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0023R.dimen.compat_notification_large_icon_max_height);
    ...
    public static abstract class Style {
        ...
        */
        public android.widget.RemoteViews applyStandardTemplate(boolean r13, int r14, boolean r15) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p008v4.app.NotificationCompat.Style.applyStandardTemplate(boolean, int, boolean):android.widget.RemoteViews");
        }
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0023R.C0024drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0023R.C0025id.notification_main_column);
            remoteViews.addView(C0023R.C0025id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0023R.C0025id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0023R.C0025id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0023R.C0025id.title, 8);
            remoteViews.setViewVisibility(C0023R.C0025id.text2, 8);
            remoteViews.setViewVisibility(C0023R.C0025id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int dimensionPixelSize = resources.getDimensionPixelSize(C0023R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0023R.dimen.notification_top_pad_large_text);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            int min;
            boolean z2 = true;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0023R.layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0023R.C0025id.actions);
            if (!z || this.mBuilder.mActions == null || (min = Math.min(this.mBuilder.mActions.size(), 3)) <= 0) {
                z2 = false;
            } else {
                for (int i = 0; i < min; i++) {
                    applyStandardTemplate.addView(C0023R.C0025id.actions, generateActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            int i2 = z2 ? 0 : 8;
            applyStandardTemplate.setViewVisibility(C0023R.C0025id.actions, i2);
            applyStandardTemplate.setViewVisibility(C0023R.C0025id.action_divider, i2);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z ? C0023R.layout.notification_action_tombstone : C0023R.layout.notification_action);
            remoteViews.setImageViewBitmap(C0023R.C0025id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0023R.color.notification_action_color_filter)));
            remoteViews.setTextViewText(C0023R.C0025id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0023R.C0025id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0023R.C0025id.action_container, action.title);
            }
            return remoteViews;
        }
    }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            @Override // android.support.p008v4.app.NotificationCompat.Action.Extender
            ...
            /* renamed from: clone */
            public WearableExtender m12956clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        @Override // android.support.p008v4.app.NotificationCompat.Extender
        public Builder extend(Builder builder) {
            Bundle bundle = new Bundle();
        ...
        /* renamed from: clone */
        public WearableExtender m12957clone() {
            WearableExtender wearableExtender = new WearableExtender();
