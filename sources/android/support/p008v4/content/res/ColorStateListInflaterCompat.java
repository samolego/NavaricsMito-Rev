...
public final class ColorStateListInflaterCompat {
    ...
    private static ColorStateList inflate(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == i || ((depth = xmlPullParser.getDepth()) < depth2 && next == 3)) {
                ...
                TypedArray obtainAttributes = obtainAttributes(resources, theme, attributeSet, C0023R.styleable.ColorStateListItem);
                int color = obtainAttributes.getColor(C0023R.styleable.ColorStateListItem_android_color, -65281);
                float f = 1.0f;
                if (obtainAttributes.hasValue(C0023R.styleable.ColorStateListItem_android_alpha)) {
                    f = obtainAttributes.getFloat(C0023R.styleable.ColorStateListItem_android_alpha, 1.0f);
                } else if (obtainAttributes.hasValue(C0023R.styleable.ColorStateListItem_alpha)) {
                    f = obtainAttributes.getFloat(C0023R.styleable.ColorStateListItem_alpha, 1.0f);
                }
                ...
                for (int i4 = 0; i4 < attributeCount; i4++) {
                    ...
                    if (attributeNameResource != 16843173 && attributeNameResource != 16843551 && attributeNameResource != C0023R.attr.alpha) {
                        int i5 = i3 + 1;
    ...
    @ColorInt
    private static int modulateColorAlpha(@ColorInt int i, @FloatRange(from = 0.0d, m12847to = 1.0d) float f) {
