package android.support.p008v4.provider;
...
import android.support.p008v4.content.res.FontResourcesParserCompat;
import android.support.p008v4.content.res.ResourcesCompat;
import android.support.p008v4.graphics.TypefaceCompat;
import android.support.p008v4.graphics.TypefaceCompatUtil;
import android.support.p008v4.provider.SelfDestructiveThread;
...
public class FontsContractCompat {
    ...
    public static Typeface getFontSync(final Context context, final FontRequest fontRequest, @Nullable final ResourcesCompat.FontCallback fontCallback, @Nullable final Handler handler, boolean z, int i, final int i2) {
        ...
        if (typeface != null) {
            ...
            SelfDestructiveThread.ReplyCallback<TypefaceResult> replyCallback = fontCallback == null ? null : new SelfDestructiveThread.ReplyCallback<TypefaceResult>() { // from class: android.support.v4.provider.FontsContractCompat.2
                @Override // android.support.p008v4.provider.SelfDestructiveThread.ReplyCallback
    ...
    public static class FontInfo {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int i, @IntRange(from = 1, m12846to = 1000) int i2, boolean z, int i3) {
