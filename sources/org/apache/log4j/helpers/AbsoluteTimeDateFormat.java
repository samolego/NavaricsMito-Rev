...
public class AbsoluteTimeDateFormat extends DateFormat {
    ...
    /* renamed from: a */
    private static long f11188a = 0;

    /* renamed from: b */
    private static char[] f11189b = new char[9];
    ...
    */
    public java.lang.StringBuffer format(java.util.Date r9, java.lang.StringBuffer r10, java.text.FieldPosition r11) {
        /*
            ...
            long r2 = (long) r11
            long r0 = r0 - r2
            long r2 = org.apache.log4j.helpers.AbsoluteTimeDateFormat.f11188a
            r4 = 0
            r5 = 10
            r6 = 48
            int r7 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
            if (r7 != 0) goto L21
            char[] r2 = org.apache.log4j.helpers.AbsoluteTimeDateFormat.f11189b
            char r3 = r2[r4]
            if (r3 != 0) goto L1d
            goto L21
        L1d:
        ...
        L5f:
            ...
            r10.append(r2)
            int r2 = r10.length()
            char[] r3 = org.apache.log4j.helpers.AbsoluteTimeDateFormat.f11189b
            r10.getChars(r9, r2, r3, r4)
            org.apache.log4j.helpers.AbsoluteTimeDateFormat.f11188a = r0
        L72:
            r9 = 100
            if (r11 >= r9) goto L79
            r10.append(r6)
