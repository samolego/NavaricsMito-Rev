...
abstract class AbstractDirectTask extends AtomicReference<Future<?>> implements Disposable {
    ...
    protected static final FutureTask<Void> FINISHED = new FutureTask<>(Functions.f9649b, null);
    protected static final FutureTask<Void> DISPOSED = new FutureTask<>(Functions.f9649b, null);
