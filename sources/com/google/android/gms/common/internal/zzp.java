...
public class zzp {
    ...
    /* renamed from: CM */
    private static final Uri f2905CM = Uri.parse("http://plus.google.com/");

    /* renamed from: CN */
    private static final Uri f2906CN = f2905CM.buildUpon().appendPath("circles").appendPath("find").build();
