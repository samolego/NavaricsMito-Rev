...
public interface zzu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzu {
        ...
        /* loaded from: classes.dex */
        private static class C3239zza implements zzu {
            private IBinder zzajf;

            C3239zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzu zzdu(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzu)) ? new C3239zza(iBinder) : (zzu) queryLocalInterface;
        }
