...
public interface zzsc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzsc {
        ...
        /* loaded from: classes.dex */
        private static class C3256zza implements zzsc {
            private IBinder zzajf;

            C3256zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzsc zzeb(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzsc)) ? new C3256zza(iBinder) : (zzsc) queryLocalInterface;
        }
