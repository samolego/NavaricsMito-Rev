...
public interface zzqx extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzqx {
        ...
        /* loaded from: classes.dex */
        private static class C3253zza implements zzqx {
            private IBinder zzajf;

            C3253zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzqx zzdp(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzqx)) ? new C3253zza(iBinder) : (zzqx) queryLocalInterface;
        }
