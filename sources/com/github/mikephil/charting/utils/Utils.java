...
public abstract class Utils {
    ...
    private static final int[] POW_10 = {1, 10, 100, 1000, Priority.DEBUG_INT, 100000, 1000000, 10000000, 100000000, 1000000000};
    ...
    public static void drawImage(Canvas canvas, Drawable drawable, int i, int i2, int i3, int i4) {
        ...
        mPPointF.f2600x = i - (i3 / 2);
        mPPointF.f2601y = i2 - (i4 / 2);
        ...
        canvas.translate(mPPointF.f2600x, mPPointF.f2601y);
    ...
    public static void drawXAxisValue(Canvas canvas, String str, float f, float f2, Paint paint, MPPointF mPPointF, float f3) {
        ...
        if (f3 != 0.0f) {
            ...
            if (mPPointF.f2600x != 0.5f || mPPointF.f2601y != 0.5f) {
                FSize sizeOfRotatedRectangleByDegrees = getSizeOfRotatedRectangleByDegrees(mDrawTextRectBuffer.width(), fontMetrics, f3);
                f -= sizeOfRotatedRectangleByDegrees.width * (mPPointF.f2600x - 0.5f);
                f2 -= sizeOfRotatedRectangleByDegrees.height * (mPPointF.f2601y - 0.5f);
            ...
            if (mPPointF.f2600x != 0.0f || mPPointF.f2601y != 0.0f) {
                f4 -= mDrawTextRectBuffer.width() * mPPointF.f2600x;
                f5 -= fontMetrics * mPPointF.f2601y;
            }
    ...
    public static void drawMultilineText(Canvas canvas, StaticLayout staticLayout, float f, float f2, TextPaint textPaint, MPPointF mPPointF, float f3) {
        ...
        if (f3 != 0.0f) {
            ...
            if (mPPointF.f2600x != 0.0f || mPPointF.f2601y != 0.0f) {
                f4 -= width * mPPointF.f2600x;
                f5 -= lineCount * mPPointF.f2601y;
            }
            canvas.save();
