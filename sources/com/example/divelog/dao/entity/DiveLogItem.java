...
public class DiveLogItem implements Serializable {
    ...
    public void update(DiveLogItem diveLogItem) {
        if (diveLogItem != null) {
            if (!C2160n.m5855a((CharSequence) diveLogItem.getModityTime())) {
                this.modityTime = diveLogItem.getModityTime();
            }
            if (!C2160n.m5855a((CharSequence) diveLogItem.getPhotoUri())) {
                this.photoUri = diveLogItem.getPhotoUri();
            }
            if (C2160n.m5855a((CharSequence) diveLogItem.getWeather())) {
                return;
            }
