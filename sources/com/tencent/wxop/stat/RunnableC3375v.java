...
public final class RunnableC2605v implements Runnable {

    /* renamed from: a */
    final /* synthetic */ String f8171a;

    /* renamed from: b */
    final /* synthetic */ C2580c f8172b;

    /* renamed from: c */
    final /* synthetic */ Context f8173c;

    /* JADX INFO: Access modifiers changed from: package-private */
    public RunnableC2605v(String str, C2580c c2580c, Context context) {
        this.f8171a = str;
        this.f8172b = c2580c;
        this.f8173c = context;
    }
    ...
    public final void run() {
        ...
        try {
            if (StatServiceImpl.m4966a(this.f8171a)) {
            ...
            if (StatConfig.isDebugEnable()) {
                ...
                statLogger4.m4877i("add begin key:" + this.f8172b.toString());
            }
            map = StatServiceImpl.f7893e;
            if (map.containsKey(this.f8172b)) {
                statLogger3 = StatServiceImpl.f7905q;
                statLogger3.error("Duplicate CustomEvent key: " + this.f8172b.toString() + ", trackCustomBeginEvent() repeated?");
                return;
            }
            map2 = StatServiceImpl.f7893e;
            if (map2.size() <= StatConfig.getMaxParallelTimmingEvents()) {
                map3 = StatServiceImpl.f7893e;
                map3.put(this.f8172b, Long.valueOf(System.currentTimeMillis()));
                return;
            }
            ...
            StatServiceImpl.m4968a(this.f8173c, th);
        }
    }
}
