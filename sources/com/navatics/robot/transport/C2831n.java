...
import org.apache.commons.pool2.InterfaceC4188f;
import org.apache.commons.pool2.impl.C4218m;
import org.apache.commons.pool2.impl.C4219n;
...
public class C2831n {
    ...
    /* renamed from: k */
    private static InterfaceC4188f f6560k;
    ...
    private static void m6232e() {
        if (f6560k == null) {
            synchronized (C2831n.class) {
                if (f6560k == null) {
                    C4219n c4219n = new C4219n();
                    c4219n.m2114a(m6233d());
                    f6560k = new C4218m(new C2832o(), c4219n);
                }
            }
        }
    }
