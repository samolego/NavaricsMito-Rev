...
import io.reactivex.disposables.InterfaceC3874b;
...
public class SensethinkGroundStation implements SharedPreferences.OnSharedPreferenceChangeListener, InterfaceC2818e {
    ...
    /* renamed from: A */
    private InterfaceC3874b f6601A;
    ...
    /* renamed from: u */
    private InterfaceC3874b f6622u;

    /* renamed from: v */
    private InterfaceC3874b f6623v;

    /* renamed from: w */
    private InterfaceC3874b f6624w;

    /* renamed from: x */
    private InterfaceC3874b f6625x;

    /* renamed from: y */
    private InterfaceC3874b f6626y;

    /* renamed from: z */
    private InterfaceC3874b f6627z;
    ...
    /* renamed from: F */
    private C3873a f6631F = new C3873a();
    ...
    private void m6082s() {
        ...
        this.f6605c = sharedPreferences.getBoolean("enableAuth", m6013a.getResources().getBoolean(R.bool.enable_auth));
        this.f6606d = sharedPreferences.getBoolean("enableSimulateSenseThinkApi", m6013a.getResources().getBoolean(R.bool.enable_simulate_sensethink_api));
        this.f6607e = sharedPreferences.getBoolean("controllerBindResult", m6013a.getResources().getBoolean(R.bool.controller_bind_result));
        this.f6608f = sharedPreferences.getBoolean("rollerBindResult", m6013a.getResources().getBoolean(R.bool.roller_bind_result));
        this.f6609g = sharedPreferences.getBoolean("alwaysNotifySearchResult", m6013a.getResources().getBoolean(R.bool.always_notify_search_result));
    }

    /* renamed from: t */
    private void m6081t() {
        Logger logger2 = logger;
        logger2.mo1508a((Object) ("SimulateSenseThinkSdkApi " + this.f6606d));
        Logger logger3 = logger;
        logger3.mo1508a((Object) ("SimulateControllerActiveResultTrue " + this.f6607e));
        Logger logger4 = logger;
        logger4.mo1508a((Object) ("SimulateDeviceActiveResultTrue " + this.f6608f));
    }
    ...
    private void m6080u() {
        ...
        this.f6613l = false;
        this.f6617p = null;
        InterfaceC3874b interfaceC3874b = this.f6622u;
        if (interfaceC3874b != null) {
            interfaceC3874b.dispose();
        }
        InterfaceC3874b interfaceC3874b2 = this.f6623v;
        if (interfaceC3874b2 != null) {
            interfaceC3874b2.dispose();
        }
        InterfaceC3874b interfaceC3874b3 = this.f6624w;
        if (interfaceC3874b3 != null) {
            interfaceC3874b3.dispose();
        }
        InterfaceC3874b interfaceC3874b4 = this.f6625x;
        if (interfaceC3874b4 != null) {
            interfaceC3874b4.dispose();
        }
        InterfaceC3874b interfaceC3874b5 = this.f6626y;
        if (interfaceC3874b5 != null) {
            interfaceC3874b5.dispose();
        }
        InterfaceC3874b interfaceC3874b6 = this.f6627z;
        if (interfaceC3874b6 != null) {
            interfaceC3874b6.dispose();
        }
        InterfaceC3874b interfaceC3874b7 = this.f6601A;
        if (interfaceC3874b7 != null) {
            interfaceC3874b7.dispose();
        }
        this.f6622u = null;
        this.f6623v = null;
        this.f6624w = null;
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String str) {
        ...
        if ("enableSimulateSenseThinkApi".equals(str)) {
            this.f6606d = sharedPreferences2.getBoolean("enableSimulateSenseThinkApi", true);
        } else if ("controllerBindResult".equals(str)) {
            this.f6607e = sharedPreferences2.getBoolean("controllerBindResult", true);
        } else if ("rollerBindResult".equals(str)) {
            this.f6608f = sharedPreferences2.getBoolean("rollerBindResult", true);
        }
    }
    ...
    /* renamed from: w */
    private AbstractC3976j<DeviceInfo> m6078w() {
        return AbstractC3976j.m3094a((InterfaceC3979l) new InterfaceC3979l() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$S1J8xZg5v89aCqNo5u-TGFC7mog
            @Override // io.reactivex.InterfaceC3979l
            public final void subscribe(InterfaceC3978k interfaceC3965k) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a */
    public static /* synthetic */ void m6154a(final InterfaceC3978k interfaceC3978k) throws Exception {
        SPDevice.getInstance().getDevInfo(new MCallBack() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$wSIdiZHRIIrqTMhPZ_LGKdAjpGE
            ...
            public final void mo9395a(Object obj) {
                SensethinkGroundStation.m6151a(interfaceC3978k, (DeviceInfo) obj);
            }
        });
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a */
    public static /* synthetic */ void m6151a(InterfaceC3978k interfaceC3978k, DeviceInfo deviceInfo) {
        interfaceC3978k.onNext(deviceInfo);
    ...
    /* renamed from: a */
    private AbstractC3976j<Boolean> m6157a(final DeviceInfo deviceInfo) {
        if (deviceInfo == null) {
            return AbstractC3976j.m3084a((Throwable) new NvException(new C2830m(49, "deviceInfo is null")));
        }
        Logger logger2 = logger;
        logger2.mo1497c((Object) ("deviceConnect, linkID " + deviceInfo.getLinkID() + ", serialNo " + deviceInfo.getSerialNo()));
        return AbstractC3976j.m3094a(new InterfaceC3979l() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$BEQzCMYSAtaknJrfcb27XsUR1f8
            @Override // io.reactivex.InterfaceC3979l
            public final void subscribe(InterfaceC3978k interfaceC3965k) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a */
    public static /* synthetic */ void m6155a(DeviceInfo deviceInfo, final InterfaceC3978k interfaceC3978k) throws Exception {
        SPSearch.getInstance().deviceLink(deviceInfo.getLinkID(), deviceInfo.getSerialNo(), new MCallBack() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$K_UhNWydaEtHNqLRJ01P7LQiuL4
            ...
            /* renamed from: onResult */
            public final void mo9395a(Object obj) {
                SensethinkGroundStation.m6149a(interfaceC3978k, (Boolean) obj);
            }
        });
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a */
    public static /* synthetic */ void m6149a(InterfaceC3978k interfaceC3978k, Boolean bool) {
        if (bool.booleanValue()) {
            interfaceC3978k.onNext(bool);
            interfaceC3978k.onComplete();
            return;
        }
        interfaceC3978k.onError(new NvException(new C2830m(68, "failed to connect to device")));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a */
    public AbstractC3976j<DeviceUser> m6148a(final String str) {
        return AbstractC3976j.m3094a(new InterfaceC3979l() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$fBKxwcmVgZYGvh69CaBhPUnBFrE
            @Override // io.reactivex.InterfaceC3979l
            public final void subscribe(InterfaceC3978k interfaceC3965k) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: c */
    public static /* synthetic */ void m6114c(String str, final InterfaceC3978k interfaceC3978k) throws Exception {
        SPDevice.getInstance().verifyUid(str, new MCallBack() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$e6wNnBllgfDGR5u9D6vSl-cxBR8
            ...
            /* renamed from: onResult */
            public final void mo9395a(Object obj) {
                SensethinkGroundStation.m6127b(interfaceC3978k, (DeviceUser) obj);
            }
        });
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: b */
    public static /* synthetic */ void m6127b(InterfaceC3978k interfaceC3978k, DeviceUser deviceUser) {
        interfaceC3978k.onNext(deviceUser);
        interfaceC3978k.onComplete();
    }

    /* renamed from: b */
    private AbstractC3976j<DeviceUser> m6126b(final String str) {
        return AbstractC3976j.m3094a(new InterfaceC3979l() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$UF_FV0-wh94-3trzgE71xGZru9Q
            @Override // io.reactivex.InterfaceC3979l
            public final void subscribe(InterfaceC3978k interfaceC3965k) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: b */
    public static /* synthetic */ void m6125b(String str, final InterfaceC3978k interfaceC3978k) throws Exception {
        SPRc.getInstance().verifyUid(str, new MCallBack() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$23oBtIBkuBo7jOawDA6slD1_tiQ
            ...
            /* renamed from: onResult */
            public final void mo9395a(Object obj) {
                SensethinkGroundStation.m6150a(interfaceC3978k, (DeviceUser) obj);
            }
        });
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a */
    public static /* synthetic */ void m6150a(InterfaceC3978k interfaceC3978k, DeviceUser deviceUser) {
        interfaceC3978k.onNext(deviceUser);
        interfaceC3978k.onComplete();
    }
    ...
    public void mo6180a(final NvDeviceInfo nvDeviceInfo, Map<String, Object> map) {
        ...
        if (this.f6605c) {
            ...
            if (!extra.isValidate()) {
                ...
                this.f6626y = m6157a(m6212a).m3072b(C3877a.m3214b()).m3103a(new InterfaceC3865e() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$0MWFbzBmH5F0qxyf_tI-fbQcQRs
                ...
                }, new InterfaceC3865e() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$jlmhF8ooisaB7BW9cwtjzKH1hGM
                    @Override // io.reactivex.p096b.InterfaceC3865e
                    /* renamed from: accept */
                    public final void mo9497a(Object obj) {
                        SensethinkGroundStation.this.m6181a(nvDeviceInfo, (Throwable) obj);
                    }
                }, new InterfaceC3861a() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$XVGwcFfgGmlyWrZbH4PgIP8tKfQ
    ...
    /* renamed from: a */
    private AbstractC3976j<CallBackMsg> m6146a(final String str, final String str2) {
        return AbstractC3976j.m3094a(new InterfaceC3979l() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$y6gmwigaC2RDBFkTPoJ7qcKX63I
            @Override // io.reactivex.InterfaceC3979l
            public final void subscribe(InterfaceC3978k interfaceC3965k) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a */
    public /* synthetic */ void m6145a(String str, String str2, final InterfaceC3978k interfaceC3978k) throws Exception {
        MCallBack mCallBack = new MCallBack() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$m3DC2LQSda8zgNSvPnsmPngnNhQ
            @Override // com.senseplay.mframe.client.MCallBack
            /* renamed from: onResult */
            public final void mo9395a(Object obj) {
                SensethinkGroundStation.this.m6107d(interfaceC3978k, (CallBackMsg) obj);
            }
        };
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: d */
    public /* synthetic */ void m6107d(InterfaceC3978k interfaceC3978k, CallBackMsg callBackMsg) {
        if (callBackMsg.getCode() == 0) {
            interfaceC3978k.onNext(callBackMsg);
            interfaceC3978k.onComplete();
            return;
        }
        interfaceC3978k.onError(new NvException(new C2830m(49, callBackMsg.getMessage(), this)));
    }

    /* renamed from: c */
    private AbstractC3976j<CallBackMsg> m6115c(final String str) {
        return AbstractC3976j.m3094a(new InterfaceC3979l() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$Fb7W_xQ1hEAaUZtPjIK9JM94198
            @Override // io.reactivex.InterfaceC3979l
            public final void subscribe(InterfaceC3978k interfaceC3965k) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a */
    public /* synthetic */ void m6147a(String str, final InterfaceC3978k interfaceC3978k) throws Exception {
        MCallBack mCallBack = new MCallBack() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$Ulo0vtXR4eM-0WLJ1fJ4tWfrJQc
            @Override // com.senseplay.mframe.client.MCallBack
            /* renamed from: onResult */
            public final void mo9395a(Object obj) {
                SensethinkGroundStation.this.m6116c(interfaceC3978k, (CallBackMsg) obj);
            }
        };
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: c */
    public /* synthetic */ void m6116c(InterfaceC3978k interfaceC3978k, CallBackMsg callBackMsg) {
        if (callBackMsg.getCode() == 0) {
        ...
        interfaceC3978k.onError(new NvException(new C2830m(65, "remote deactivate success", this)));
    }

    /* renamed from: a */
    private AbstractC3976j<CallBackMsg> m6175a(final C2851c c2851c, final String str, final String str2) {
        return AbstractC3976j.m3094a(new InterfaceC3979l() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$ZWHqVTSt1uAanPmTRXlfdHU2qBg
            @Override // io.reactivex.InterfaceC3979l
            public final void subscribe(InterfaceC3978k interfaceC3965k) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a */
    public static /* synthetic */ void m6174a(final C2851c c2851c, String str, String str2, final InterfaceC3978k interfaceC3978k) throws Exception {
        MCallBack mCallBack = new MCallBack() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$Ne40WqnDCleExqsgwPpyfP2d4Do
            @Override // com.senseplay.mframe.client.MCallBack
            /* renamed from: onResult */
            public final void mo9395a(Object obj) {
                SensethinkGroundStation.m6108d(interfaceC3978k, c2851c, (CallBackMsg) obj);
            }
        };
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: d */
    public static /* synthetic */ void m6108d(InterfaceC3978k interfaceC3978k, C2851c c2851c, CallBackMsg callBackMsg) {
        if (callBackMsg.getCode() == 0) {
        ...
        interfaceC3978k.onError(new NvException(new C2830m(49, callBackMsg.getMessage(), c2851c)));
    }

    /* renamed from: a */
    private AbstractC3976j<CallBackMsg> m6177a(final C2851c c2851c, final String str) {
        return AbstractC3976j.m3094a(new InterfaceC3979l() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$2lKlX_05HAIZ2SBeKP9yrPJpvXo
            @Override // io.reactivex.InterfaceC3979l
            public final void subscribe(InterfaceC3978k interfaceC3965k) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a */
    public static /* synthetic */ void m6176a(final C2851c c2851c, String str, final InterfaceC3978k interfaceC3978k) throws Exception {
        MCallBack mCallBack = new MCallBack() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$EuuRoL4MA_xUzNND5Yz60qGRUZE
            @Override // com.senseplay.mframe.client.MCallBack
            /* renamed from: onResult */
            public final void mo9395a(Object obj) {
                SensethinkGroundStation.m6117c(interfaceC3978k, c2851c, (CallBackMsg) obj);
            }
        };
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: c */
    public static /* synthetic */ void m6117c(InterfaceC3978k interfaceC3978k, C2851c c2851c, CallBackMsg callBackMsg) {
        if (callBackMsg.getCode() == 0) {
        ...
        interfaceC3978k.onError(new NvException(new C2830m(65, "clear uid failed", c2851c)));
    }
    ...
    /* renamed from: a */
    private AbstractC3976j<CallBackMsg> m6141a(final String str, final String str2, final String str3, final String str4) {
        if (this.f6606d) {
            if (this.f6607e) {
                return m6146a(str2, str);
            }
            return AbstractC3976j.m3084a((Throwable) new NvException(new C2830m(254, "simulate remote active err", this)));
        }
        return AbstractC3976j.m3094a(new InterfaceC3979l() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$cxoj9Y3Yg17JueQdBWY4B_Zxx0g
            @Override // io.reactivex.InterfaceC3979l
            public final void subscribe(InterfaceC3978k interfaceC3965k) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a */
    public /* synthetic */ void m6139a(String str, String str2, String str3, String str4, final InterfaceC3978k interfaceC3978k) throws Exception {
        ...
        SPRc.getInstance().bindRc(str, str2, str3, str4, new MCallBack() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$53fvTjkpWrGmGfBbO9cxlvcGwek
            ...
            /* renamed from: onResult */
            public final void mo9395a(Object obj) {
                SensethinkGroundStation.this.m6128b(interfaceC3978k, (CallBackMsg) obj);
            }
        });
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: b */
    public /* synthetic */ void m6128b(InterfaceC3978k interfaceC3978k, CallBackMsg callBackMsg) {
        if (callBackMsg.getCode() == 0) {
            logger.mo1497c((Object) "activate success !!!!!!!!!!!!!!");
            interfaceC3978k.onNext(callBackMsg);
            interfaceC3978k.onComplete();
        ...
        interfaceC3978k.onError(new NvException(new C2830m(49, getErrorStringFromSensethinkErrorCode(callBackMsg.getCode(), callBackMsg.getMessage()), this)));
    }

    /* renamed from: a */
    private AbstractC3976j<CallBackMsg> m6144a(final String str, final String str2, final String str3) {
        if (this.f6606d) {
            if (this.f6607e) {
                return m6115c(str2);
            }
        ...
        return AbstractC3976j.m3094a(new InterfaceC3979l() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$ycDH85E0SFrjBYPWTAB68K4qWXw
            @Override // io.reactivex.InterfaceC3979l
            public final void subscribe(InterfaceC3978k interfaceC3965k) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a */
    public /* synthetic */ void m6142a(String str, String str2, String str3, final InterfaceC3978k interfaceC3978k) throws Exception {
        ...
        SPRc.getInstance().unBindRc(str, str2, str3, new MCallBack() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$N7aTjzPe_IETI8QDzJ1TPtOWJIQ
            ...
            /* renamed from: onResult */
            public final void mo9395a(Object obj) {
                SensethinkGroundStation.this.m6152a(interfaceC3978k, (CallBackMsg) obj);
            }
        });
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a */
    public /* synthetic */ void m6152a(InterfaceC3978k interfaceC3978k, CallBackMsg callBackMsg) {
        if (callBackMsg.getCode() == 0) {
            logger.mo1497c((Object) "remote deactivate success !!!!!!!!!!!!!!");
            interfaceC3978k.onNext(callBackMsg);
            interfaceC3978k.onComplete();
        ...
        interfaceC3978k.onError(new NvException(new C2830m(65, getErrorStringFromSensethinkErrorCode(callBackMsg.getCode(), callBackMsg.getMessage()), this)));
    }

    /* JADX INFO: Access modifiers changed from: private */
    @SuppressLint({"HandlerLeak"})
    /* renamed from: a */
    public AbstractC3976j<CallBackMsg> m6172a(final C2851c c2851c, final String str, final String str2, final String str3, final String str4) {
        if (this.f6606d) {
            if (this.f6608f) {
                return m6175a(c2851c, str2, str);
            }
            return AbstractC3976j.m3084a((Throwable) new NvException(new C2830m(254, "simulate remote active err", c2851c)));
        }
        return AbstractC3976j.m3094a(new InterfaceC3979l() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$7a9GMen1LmbLLtKu1DyVJs9olks
            @Override // io.reactivex.InterfaceC3979l
            public final void subscribe(InterfaceC3978k interfaceC3965k) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a */
    public /* synthetic */ void m6140a(String str, String str2, String str3, String str4, final C2851c c2851c, final InterfaceC3978k interfaceC3978k) throws Exception {
        Log.d("ContentValues", "rc绑定参数 ：uuId = " + str + ", rcSn = " + str2 + "， accessToken = " + str3 + ", verifyCode = " + str4);
        SPDevice.getInstance().bindDevice(str, str2, str3, str4, new MCallBack() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$CMxYC34NlcR-7iTakGOH3ffTudY
            ...
            /* renamed from: onResult */
            public final void mo9395a(Object obj) {
                SensethinkGroundStation.this.m6129b(interfaceC3978k, c2851c, (CallBackMsg) obj);
            }
        });
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: b */
    public /* synthetic */ void m6129b(InterfaceC3978k interfaceC3978k, C2851c c2851c, CallBackMsg callBackMsg) {
        if (callBackMsg.getCode() == 0) {
        ...
        interfaceC3978k.onError(new NvException(new C2830m(49, getErrorStringFromSensethinkErrorCode(callBackMsg.getCode(), callBackMsg.getMessage()), c2851c)));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a */
    public AbstractC3976j<CallBackMsg> m6173a(final C2851c c2851c, final String str, final String str2, final String str3) {
        if (this.f6606d) {
            if (this.f6608f) {
        ...
        return AbstractC3976j.m3094a(new InterfaceC3979l() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$t7VOwOj9CKBMYSloVaZfDVlqQXs
            @Override // io.reactivex.InterfaceC3979l
            public final void subscribe(InterfaceC3978k interfaceC3965k) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a */
    public static /* synthetic */ void m6143a(String str, String str2, String str3, final C2851c c2851c, final InterfaceC3978k interfaceC3978k) throws Exception {
        Log.d("ContentValues", "rc绑定参数 ：uuId = " + str + ", rcSn = " + str2 + "， accessToken = " + str3);
        SPDevice.getInstance().unBindDevice(str, str2, str3, new MCallBack() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$k7cSgDmJYYW9sp1f8Dg2zpp1plo
            ...
            /* renamed from: onResult */
            public final void mo9395a(Object obj) {
                SensethinkGroundStation.m6153a(interfaceC3978k, c2851c, (CallBackMsg) obj);
            }
        });
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a */
    public static /* synthetic */ void m6153a(InterfaceC3978k interfaceC3978k, C2851c c2851c, CallBackMsg callBackMsg) {
        if (callBackMsg.getCode() == 0) {
        ...
        interfaceC3978k.onError(new NvException(new C2830m(49, "device deactivate failed", c2851c)));
    }
    ...
    private void m6076y() {
        ...
        C3795b.m3489a(m6078w(), this.f6631F, new InterfaceC3865e() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$eqZzm4du3YqN3mq8v2qO-bzKggI
            @Override // io.reactivex.p096b.InterfaceC3865e
            /* renamed from: accept */
            public final void mo9497a(Object obj) {
    ...
    public void mo6137a(Map<String, Object> map) {
        ...
        if (!this.f6605c) {
            ...
            this.f6622u = m6126b((String) map.get("uuid")).m3072b(C3854a.m3247a()).m3103a(new C28472(), new InterfaceC3865e() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$tveHg1w4_Y9GtyLirPZzgkFWwFM
                @Override // io.reactivex.p096b.InterfaceC3865e
                /* renamed from: accept */
                public final void mo9497a(Object obj) {
                    SensethinkGroundStation.this.m6113c((Throwable) obj);
                }
            }, new InterfaceC3861a() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$m_xuan0TuGJ4VSa64jyaAC3gfsU
                @Override // io.reactivex.p096b.InterfaceC3861a
                public final void run() {
    ...
    /* loaded from: classes2.dex */
    public class C28472 implements InterfaceC3865e<DeviceUser> {
        C28472() {
        }
    ...
    public void mo6123b(Map<String, Object> map) {
        ...
        this.f6623v = m6141a(str, str2, str3, str4).m3103a(new InterfaceC3865e() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$awe9hncqV6t4C9MoRmuyReiRKx8
            @Override // io.reactivex.p096b.InterfaceC3865e
            /* renamed from: accept */
            public final void mo9497a(Object obj) {
                SensethinkGroundStation.this.m6131b((CallBackMsg) obj);
            }
        }, new InterfaceC3865e() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$7k6rOhDiCCQjCTEC1957mu6d-nI
            @Override // io.reactivex.p096b.InterfaceC3865e
            /* renamed from: accept */
            public final void mo9497a(Object obj) {
                SensethinkGroundStation.this.m6124b((Throwable) obj);
            }
        }, new InterfaceC3861a() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$-Hk11m2NMjPefFEiJxzUXQ8ytyE
            @Override // io.reactivex.p096b.InterfaceC3861a
            public final void run() {
    ...
    public void mo6112c(Map<String, Object> map) {
        ...
        if (C2904n.m5850a((CharSequence) str2) || C2904n.m5850a((CharSequence) str) || C2904n.m5850a((CharSequence) str3)) {
            ...
            this.f6624w = m6144a(str2, str, str3).m3103a(new InterfaceC3865e() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$8lTVKFx4lhlnuW5yrDFBHAifKh4
                @Override // io.reactivex.p096b.InterfaceC3865e
                /* renamed from: accept */
                public final void mo9497a(Object obj) {
                    SensethinkGroundStation.this.m6158a((CallBackMsg) obj);
                }
            }, new InterfaceC3865e() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$lqXcjZiqI1sZ9hIuKGuMJ_ERoyM
                @Override // io.reactivex.p096b.InterfaceC3865e
                /* renamed from: accept */
                public final void mo9497a(Object obj) {
                    SensethinkGroundStation.this.m6138a((Throwable) obj);
                }
            }, new InterfaceC3861a() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$OpyWmoeONrSY8Yc_cXZzdqNAgqE
                @Override // io.reactivex.p096b.InterfaceC3861a
                public final void run() {
    ...
    public class C2851c extends AbstractC2856t {
        ...
        public void mo6027a(Map<String, Object> map) {
            if (SensethinkGroundStation.this.f6605c) {
                if (!SPUsb.getInstance().checkUsb()) {
                    SensethinkGroundStation.this.m6187a(16711682, new C2830m(50, "usb not ready", this));
                    return;
                }
                SensethinkGroundStation sensethinkGroundStation = SensethinkGroundStation.this;
                sensethinkGroundStation.f6627z = sensethinkGroundStation.m6148a((String) map.get("uuid")).m3072b(C3854a.m3247a()).m3103a(new InterfaceC3865e() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$c$r5SctuvmXjIdaeeUMPRXhaMb9Us
                    @Override // io.reactivex.p096b.InterfaceC3865e
                    /* renamed from: accept */
                    public final void mo9497a(Object obj) {
                        SensethinkGroundStation.C2851c.this.m6060a((DeviceUser) obj);
                    }
                }, new InterfaceC3865e() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$c$J7LK6fJqZacuP2BeNw3Tf6N3Yfc
                    @Override // io.reactivex.p096b.InterfaceC3865e
                    /* renamed from: accept */
                    public final void mo9497a(Object obj) {
                        SensethinkGroundStation.C2851c.this.m6056c((Throwable) obj);
                    }
                }, new InterfaceC3861a() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$c$yCkOY6m2ERL6b-qsmst4H-ub2fU
                    @Override // io.reactivex.p096b.InterfaceC3861a
                    public final void run() {
        ...
        public void mo6024b(Map<String, Object> map) {
            if (SensethinkGroundStation.this.f6605c) {
                ...
                SensethinkGroundStation sensethinkGroundStation = SensethinkGroundStation.this;
                sensethinkGroundStation.f6601A = sensethinkGroundStation.m6172a(this, str, str2, str3, str4).m3103a(new InterfaceC3865e() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$c$BdVNauP_tB5twNkdqzR_mg800OU
                    @Override // io.reactivex.p096b.InterfaceC3865e
                    /* renamed from: accept */
                    public final void mo9497a(Object obj) {
                        SensethinkGroundStation.C2851c.this.m6058b((CallBackMsg) obj);
                    }
                }, new InterfaceC3865e() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$c$FBOqRK45ossu9MCsLfCckNPS640
                    @Override // io.reactivex.p096b.InterfaceC3865e
                    /* renamed from: accept */
                    public final void mo9497a(Object obj) {
                        SensethinkGroundStation.C2851c.this.m6057b((Throwable) obj);
                    }
                }, new InterfaceC3861a() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$c$jhvDE5OFeE7WsN3kBPZd7eCbgQc
                    @Override // io.reactivex.p096b.InterfaceC3861a
                    public final void run() {
        ...
        public void mo6021c(Map<String, Object> map) {
            if (SensethinkGroundStation.this.f6605c) {
                ...
                SensethinkGroundStation sensethinkGroundStation = SensethinkGroundStation.this;
                sensethinkGroundStation.f6625x = sensethinkGroundStation.m6173a(this, str, str2, str3).m3103a(new InterfaceC3865e() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$c$lB7GwkX6lnEyRDF8wG-20wyyseQ
                    @Override // io.reactivex.p096b.InterfaceC3865e
                    /* renamed from: accept */
                    public final void mo9497a(Object obj) {
                        SensethinkGroundStation.C2851c.this.m6061a((CallBackMsg) obj);
                    }
                }, new InterfaceC3865e() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$c$7msPUOb1caPkhSfprcFKE55rYY0
                    @Override // io.reactivex.p096b.InterfaceC3865e
                    /* renamed from: accept */
                    public final void mo9497a(Object obj) {
                        SensethinkGroundStation.C2851c.this.m6059a((Throwable) obj);
                    }
                }, new InterfaceC3861a() { // from class: com.navatics.robot.transport.ss.-$$Lambda$d$c$DUsTOyVnf15qc4xHzE6b7yiVtac
                    @Override // io.reactivex.p096b.InterfaceC3861a
                    public final void run() {
