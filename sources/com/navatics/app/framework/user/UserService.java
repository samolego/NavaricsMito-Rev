...
public interface UserService {
    ...
    @GET(m122a = "activemqserver/sendMsg/diveLogByte")
    Observable<Result<String>> getLatestVersion(@Field(m125a = "startTime") long j);
    ...
    @GET(m122a = "newsdk/user/spSendCode")
    ...
    @GET(m122a = "newsdk/user/getUserById")
    ...
    @FormUrlEncoded
    @POST(m113a = "newsdk/user/alterUserInfo")
    ...
    @FormUrlEncoded
    @POST(m113a = "newsdk/user/register")
    ...
    @GET(m122a = "newsdk/user/resetPwd")
