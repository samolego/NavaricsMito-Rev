...
public class KeyMapFormat {
    ...
    public String toKeyMapString() {
        String str;
        return to16Hex(str.length() / 2) + (getKeymap_type() + toDefString(getEvent()) + to16Hex(getCondition_count()) + toString(getOptional_conditions()) + getCommand() + getCommand_ver() + toString(getParams()));
    }
