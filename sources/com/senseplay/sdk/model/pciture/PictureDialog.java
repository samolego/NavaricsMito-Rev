...
public class PictureDialog extends Dialog {
    ...
    public PictureDialog(@NonNull Context context) {
        super(context, C2189R.style.alert_dialog);
    }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C2189R.layout.dialog_picture);
        initView();
        setParams();
    }
    ...
    private void initView() {
        ...
        this.btn_picture = (Button) findViewById(C2189R.C2191id.btn_picture);
        ...
        this.btn_photo = (Button) findViewById(C2189R.C2191id.btn_photo);
        ...
        this.btn_cancel = (Button) findViewById(C2189R.C2191id.btn_cancel);
