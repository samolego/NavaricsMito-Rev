...
public class zzse {
    ...
    /* renamed from: CR */
    private final String f3361CR;

    /* renamed from: Dk */
    private final com.google.android.gms.common.internal.zzq f3362Dk;

    /* renamed from: bX */
    private final int f3363bX;
    private final String mTag;

    private zzse(String str, String str2) {
        this.f3361CR = str2;
        this.mTag = str;
        this.f3362Dk = new com.google.android.gms.common.internal.zzq(str);
        this.f3363bX = getLogLevel();
    }
    ...
    protected String format(String str, Object... objArr) {
        ...
        return this.f3361CR.concat(str);
    }
