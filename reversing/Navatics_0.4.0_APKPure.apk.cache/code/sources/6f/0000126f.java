...
public interface zzsv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzsv {
        ...
        /* loaded from: classes.dex */
        private static class C3579zza implements zzsv {
            private IBinder zzajf;

            C3579zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzsv zzff(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzsv)) ? new C3579zza(iBinder) : (zzsv) queryLocalInterface;
        }
