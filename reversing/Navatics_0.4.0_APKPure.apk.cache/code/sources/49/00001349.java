...
public class FlatBufferBuilder {
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory) {
        ...
        this.f3418bb = byteBufferFactory.newByteBuffer(i);
    }
    ...
    public FlatBufferBuilder init(ByteBuffer byteBuffer, ByteBufferFactory byteBufferFactory) {
        this.bb_factory = byteBufferFactory;
        this.f3418bb = byteBuffer;
        this.f3418bb.clear();
        this.f3418bb.order(ByteOrder.LITTLE_ENDIAN);
        this.minalign = 1;
        this.space = this.f3418bb.capacity();
        this.vtable_in_use = 0;
        this.nested = false;
        this.finished = false;
        this.object_start = 0;
    ...
    public int offset() {
        return this.f3418bb.capacity() - this.space;
    }

    public void pad(int i) {
        for (int i2 = 0; i2 < i; i2++) {
            ByteBuffer byteBuffer = this.f3418bb;
            int i3 = this.space - 1;
            this.space = i3;
    ...
    public void prep(int i, int i2) {
        ...
        int i3 = ((~((this.f3418bb.capacity() - this.space) + i2)) + 1) & (i - 1);
        while (this.space < i3 + i + i2) {
            int capacity = this.f3418bb.capacity();
            this.f3418bb = growByteBuffer(this.f3418bb, this.bb_factory);
            this.space += this.f3418bb.capacity() - capacity;
        }
        pad(i3);
    }
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer order = this.f3418bb.slice().order(ByteOrder.LITTLE_ENDIAN);
        order.limit(i4);
        return order;
    }
    ...
    public <T extends Table> int createSortedVectorOfTables(T t, int[] iArr) {
        t.sortTables(iArr, this.f3418bb);
    ...
    public int createString(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f3418bb;
        int i = this.space - remaining;
        this.space = i;
        byteBuffer2.position(i);
        this.f3418bb.put(byteBuffer);
        return endVector();
    }
    ...
    public int endObject() {
        ...
        loop2: while (true) {
            ...
            int capacity = this.f3418bb.capacity() - this.vtables[i4];
            int i5 = this.space;
            short s = this.f3418bb.getShort(capacity);
            if (s == this.f3418bb.getShort(i5)) {
                for (int i6 = 2; i6 < s; i6 += 2) {
                    if (this.f3418bb.getShort(capacity + i6) != this.f3418bb.getShort(i5 + i6)) {
                        break;
                    }
                }
                i = this.vtables[i4];
        ...
        if (i != 0) {
            this.space = this.f3418bb.capacity() - offset;
            this.f3418bb.putInt(this.space, i - offset);
        } else {
    ...
    public void required(int i, int i2) {
        int capacity = this.f3418bb.capacity() - i;
        if (this.f3418bb.getShort((capacity - this.f3418bb.getInt(capacity)) + i2) != 0) {
            return;
        }
    ...
    protected void finish(int i, boolean z) {
        ...
        addOffset(i);
        if (z) {
            addInt(this.f3418bb.capacity() - this.space);
        }
        this.f3418bb.position(this.space);
        this.finished = true;
    }
    ...
    public byte[] sizedByteArray(int i, int i2) {
        ...
        this.f3418bb.position(i);
        this.f3418bb.get(bArr);
        return bArr;
    }

    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f3418bb.capacity() - this.space);
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer duplicate = this.f3418bb.duplicate();
        duplicate.position(this.space);
        duplicate.limit(this.f3418bb.capacity());
