...
class MFileClient {
    ...
    private void downloadFile(String str) {
        try {
            ...
            if (httpURLConnection.getResponseCode() == 200) {
                ...
                MDebug.m7023e("MFileClient", "文件下载失败");
            }
            httpURLConnection.disconnect();
        } catch (Error e) {
            MDebug.m7023e("MFileClient", e.toString());
        } catch (Exception e2) {
            MDebug.m7023e("MFileClient", e2.toString());
        }
    }
    ...
    private void upLoadFile(String str, String str2, HashMap<String, String> hashMap) {
        try {
            ...
            if (httpURLConnection.getResponseCode() == 200) {
                MDebug.m7023e("MFileClient", "上传成功，result--->" + streamToString(httpURLConnection.getInputStream()));
                return;
            }
            MDebug.m7023e("MFileClient", "上传失败");
        } catch (IOException e) {
            MDebug.m7023e("MFileClient", e.toString());
        } catch (Error e2) {
            MDebug.m7023e("MFileClient", e2.toString());
