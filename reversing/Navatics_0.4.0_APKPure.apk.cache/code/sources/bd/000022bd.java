...
/* renamed from: com.yanzhenjie.recyclerview.h, reason: use source file name */
/* loaded from: classes2.dex */
class RightHorizontal extends AbstractC2725c {
    public RightHorizontal(View view) {
        super(-1, view);
    }

    /* renamed from: b */
    public boolean m9044b(int i) {
        int b = (-m9040c().getWidth()) * m9038b();
        return i >= b && b != 0;
    }

    /* renamed from: c */
    public boolean m9045c(int i) {
    ...
    public boolean mo9037a(int i, float f) {
        return f < ((float) (i - m9040c().getWidth()));
    }
}