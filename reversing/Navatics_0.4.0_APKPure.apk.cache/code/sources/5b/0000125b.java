...
public interface zzsd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzsd {
        ...
        /* loaded from: classes.dex */
        private static class C3577zza implements zzsd {
            private IBinder zzajf;

            C3577zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzsd zzec(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzsd)) ? new C3577zza(iBinder) : (zzsd) queryLocalInterface;
        }
