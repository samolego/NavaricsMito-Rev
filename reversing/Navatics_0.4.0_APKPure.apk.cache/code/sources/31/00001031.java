...
public class zza {
    ...
    /* loaded from: classes.dex */
    public static class C3554zza extends RuntimeException {
        /* JADX WARN: Illegal instructions before constructor call */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        public C3554zza(java.lang.String r4, android.os.Parcel r5) {
            /*
                r3 = this;
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.internal.safeparcel.zza.C3554zza.<init>(java.lang.String, android.os.Parcel):void");
        }
    }
    ...
    private static void zza(Parcel parcel, int i, int i2) {
        ...
        sb.append(valueOf);
        sb.append(")");
        throw new C3554zza(sb.toString(), parcel);
    }
    ...
    public static int zzcq(Parcel parcel) {
        ...
        if (zzgv(zzcp) != 20293) {
            ...
            throw new C3554zza(valueOf.length() != 0 ? "Expected object header. Got 0x".concat(valueOf) : new String("Expected object header. Got 0x"), parcel);
        }
