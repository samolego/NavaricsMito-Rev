...
public class HtmlEntities {
    ...
    public interface a {
        /* renamed from: a */
        int mo8896a(String str);

        /* renamed from: a */
        void mo8897a(String str, int i);
    }
    ...
    /* renamed from: a */
    static void m8891a(HtmlEntities htmlEntities) {
        htmlEntities.m8894a(f9097e);
        htmlEntities.m8894a(f9095b);
        htmlEntities.m8894a(f9096c);
    }
    ...
    static class c implements a {
        ...
        /* renamed from: a */
        private final Map f9099a = new HashMap();

        /* renamed from: b */
        private final IntHashMap f9100b = new IntHashMap();

        c() {
        }

        @Override // com.twitter.sdk.android.tweetui.internal.p069a.HtmlEntities.a
        /* renamed from: a */
        public void mo8897a(String str, int i) {
            this.f9099a.put(str, Integer.valueOf(i));
            this.f9100b.m8898a(i, str);
        }

        @Override // com.twitter.sdk.android.tweetui.internal.p069a.HtmlEntities.a
        /* renamed from: a */
        public int mo8896a(String str) {
            Object obj = this.f9099a.get(str);
            if (obj == null) {
                return -1;
            }
    ...
    public static final class d {
        ...
        /* renamed from: b */
        public final ArrayList<int[]> f9102b;
    ...
    /* renamed from: a */
    public void m8894a(String[][] strArr) {
        for (String[] strArr2 : strArr) {
            m8893a(strArr2[0], Integer.parseInt(strArr2[1]));
        }
    }

    /* renamed from: a */
    public void m8893a(String str, int i) {
        this.f9098d.mo8897a(str, i);
    }

    /* renamed from: a */
    public int m8892a(String str) {
        return this.f9098d.mo8896a(str);
    }

    /* renamed from: b */
    public d m8895b(String str) {
        int i;
        int intValue;
        ...
        return new d(sb.toString(), arrayList);
    }
}