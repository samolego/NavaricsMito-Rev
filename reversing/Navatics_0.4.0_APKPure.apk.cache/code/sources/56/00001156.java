...
public final class zzapf<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    zzd<K, V> zza(K k, boolean z) {
        ...
        if (zzdVar2 != null) {
            ...
            while (true) {
                i = comparable != null ? comparable.compareTo(zzdVar2.aXd) : comparator.compare(k, zzdVar2.aXd);
                if (i == 0) {
                    return zzdVar2;
                }
    ...
    void zza(zzd<K, V> zzdVar, boolean z) {
        ...
        zzd<K, V> m3283bk = zzdVar2.height > zzdVar3.height ? zzdVar2.m3283bk() : zzdVar3.m3282bj();
        zza((zzd) m3283bk, false);
        ...
        m3283bk.height = Math.max(i, i2) + 1;
        zza(zzdVar, m3283bk);
    }
