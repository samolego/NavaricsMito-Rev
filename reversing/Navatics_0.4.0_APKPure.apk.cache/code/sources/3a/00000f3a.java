...
public class Approximator {
    ...
    private class Line {
        ...
        /* renamed from: dx */
        private float f2593dx;

        /* renamed from: dy */
        private float f2594dy;
        private float exsy;
        ...
        public Line(float f, float f2, float f3, float f4) {
            ...
            this.sxey = f * f4;
            this.exsy = f3 * f2;
            float f5 = this.f2593dx;
            float f6 = this.f2594dy;
            this.length = (float) Math.sqrt((f5 * f5) + (f6 * f6));
            this.points = new float[]{f, f2, f3, f4};
        }

        public float distance(float f, float f2) {
            return Math.abs((((this.f2594dy * f) - (this.f2593dx * f2)) + this.sxey) - this.exsy) / this.length;
        }
