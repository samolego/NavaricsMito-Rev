...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f3428FS = 28;

    /* renamed from: GS */
    private static final char f3429GS = 29;
    private static final char LATCHA = 65527;
    private static final char LATCHB = 65528;
    private static final char LOCK = 65529;

    /* renamed from: NS */
    private static final char f3430NS = 65531;
    private static final char PAD = 65532;

    /* renamed from: RS */
    private static final char f3431RS = 30;
        ...
        switch (i) {
            ...
            case 3:
                ...
                if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                    sb.insert(9, postCode3 + f3429GS + format + f3429GS + format2 + f3429GS);
                    break;
                } else {
                    sb.insert(0, postCode3 + f3429GS + format + f3429GS + format2 + f3429GS);
                    break;
                }
            case 4:
        ...
        while (i3 < i + i2) {
            ...
            switch (charAt) {
                ...
                case 65531:
                    ...
                    int i11 = i9 + 1;
                    int i12 = i10 + (bArr[i11] << LOGIN_ACK_REL.LOGIN_ACK_REL_REPEAT_LOGIN);
                    int i13 = i11 + 1;
