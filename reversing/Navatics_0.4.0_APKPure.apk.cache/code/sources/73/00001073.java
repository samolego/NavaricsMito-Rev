...
public class zzp {
    ...
    /* renamed from: CM */
    private static final Uri f2913CM = Uri.parse("http://plus.google.com/");

    /* renamed from: CN */
    private static final Uri f2914CN = f2913CM.buildUpon().appendPath("circles").appendPath("find").build();
