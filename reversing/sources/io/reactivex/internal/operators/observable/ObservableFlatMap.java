...
public final class ObservableFlatMap<T, U> extends AbstractObservableWithUpstream<T, U> {
    ...
    /* renamed from: b */
    final Function<? super T, ? extends ObservableSource<? extends U>> f9704b;

    /* renamed from: c */
    final boolean f9705c;
    ...
    public void mo158a(InterfaceC2900o<? super U> interfaceC2900o) {
        if (ObservableScalarXMap.m3178a(this.f9731a, interfaceC2900o, this.f9704b)) {
            return;
        }
        this.f9731a.subscribe(new MergeObserver(interfaceC2900o, this.f9704b, this.f9705c, this.f9706d, this.f9707e));
    }

    /* loaded from: classes2.dex */
    static final class MergeObserver<T, U> extends AtomicInteger implements Disposable, InterfaceC2900o<T> {
        ...
        MergeObserver(InterfaceC2900o<? super U> interfaceC2900o, Function<? super T, ? extends ObservableSource<? extends U>> function, boolean z, int i, int i2) {
        ...
        public void onNext(T t) {
            ...
            try {
                ObservableSource<? extends U> observableSource = (ObservableSource) ObjectHelper.m3188a(this.mapper.apply(t), "The mapper returned a null ObservableSource");
        ...
        public void dispose() {
            ...
            this.cancelled = true;
            if (!disposeAll() || (terminate = this.errors.terminate()) == null || terminate == ExceptionHelper.f9863a) {
                return;
            }
            RxJavaPlugins.m3233a(terminate);
        }
        ...
        */
        ...
        boolean checkTerminate() {
            ...
            if (terminate != ExceptionHelper.f9863a) {
    ...
    /* loaded from: classes2.dex */
    public static final class InnerObserver<T, U> extends AtomicReference<Disposable> implements InterfaceC2900o<U> {
