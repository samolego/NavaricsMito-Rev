...
import android.support.p008v4.view.ViewPropertyAnimatorListener;
import android.support.p008v4.view.ViewPropertyAnimatorListenerAdapter;
import android.support.p008v4.view.ViewPropertyAnimatorUpdateListener;
...
import android.support.p011v7.view.ActionBarPolicy;
import android.support.p011v7.view.ActionMode;
import android.support.p011v7.view.SupportMenuInflater;
import android.support.p011v7.view.ViewPropertyAnimatorCompatSet;
import android.support.p011v7.view.menu.MenuBuilder;
import android.support.p011v7.view.menu.MenuPopupHelper;
...
import android.support.p011v7.widget.DecorToolbar;
import android.support.p011v7.widget.ScrollingTabContainerView;
...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new ViewPropertyAnimatorUpdateListener() { // from class: android.support.v7.app.WindowDecorActionBar.3
        @Override // android.support.p008v4.view.ViewPropertyAnimatorUpdateListener
    ...
    @Override // android.support.p011v7.widget.ActionBarOverlayLayout.ActionBarVisibilityCallback
    public void onContentScrollStopped() {
    }

    @Override // android.support.p011v7.app.ActionBar
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0425R.C0427id.decor_content_parent);
        ActionBarOverlayLayout actionBarOverlayLayout = this.mOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0425R.C0427id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0425R.C0427id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0425R.C0427id.action_bar_container);
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(null, C0425R.styleable.ActionBar, C0425R.attr.actionBarStyle, 0);
        if (obtainStyledAttributes.getBoolean(C0425R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0425R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0425R.attr.actionBarWidgetTheme, typedValue, true);
    ...
    public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
        ...
        @Override // android.support.p011v7.view.ActionMode
    ...
    public class TabImpl extends ActionBar.Tab {
        ...
        @Override // android.support.p011v7.app.ActionBar.Tab
