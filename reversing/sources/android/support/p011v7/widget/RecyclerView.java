...
import android.support.p008v4.p010os.TraceCompat;
import android.support.p008v4.util.Preconditions;
import android.support.p008v4.view.AbsSavedState;
import android.support.p008v4.view.NestedScrollingChild2;
import android.support.p008v4.view.NestedScrollingChildHelper;
import android.support.p008v4.view.ScrollingView;
import android.support.p008v4.view.ViewCompat;
import android.support.p008v4.view.ViewConfigurationCompat;
import android.support.p008v4.view.accessibility.AccessibilityEventCompat;
import android.support.p008v4.view.accessibility.AccessibilityNodeInfoCompat;
import android.support.p008v4.widget.EdgeEffectCompat;
import android.support.p011v7.recyclerview.C0454R;
import android.support.p011v7.widget.AdapterHelper;
import android.support.p011v7.widget.ChildHelper;
import android.support.p011v7.widget.GapWorker;
import android.support.p011v7.widget.ViewBoundsCheck;
import android.support.p011v7.widget.ViewInfoStore;
...
public class RecyclerView extends ViewGroup implements NestedScrollingChild2, ScrollingView {
    ...
    public void onScrolled(@InterfaceC0019Px int i, @InterfaceC0019Px int i2) {
    }
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mViewInfoProcessCallback = new ViewInfoStore.ProcessCallback() { // from class: android.support.v7.widget.RecyclerView.4
            @Override // android.support.p011v7.widget.ViewInfoStore.ProcessCallback
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0454R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes2.getString(C0454R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes2.getInt(C0454R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes2.getBoolean(C0454R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes2.getDrawable(C0454R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes2.getDrawable(C0454R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes2.getDrawable(C0454R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes2.getDrawable(C0454R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new ChildHelper.Callback() { // from class: android.support.v7.widget.RecyclerView.5
            @Override // android.support.p011v7.widget.ChildHelper.Callback
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback() { // from class: android.support.v7.widget.RecyclerView.6
            @Override // android.support.p011v7.widget.AdapterHelper.Callback
    ...
    */
    boolean scrollByInternal(int r19, int r20, android.view.MotionEvent r21) {
        ...
        L76:
            ...
            boolean r0 = android.support.p008v4.view.MotionEventCompat.isFromSource(r10, r0)
            if (r0 != 0) goto L94
            float r0 = r21.getX()
            float r1 = (float) r13
            float r2 = r21.getY()
        ...
        Lb1:
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p011v7.widget.RecyclerView.scrollByInternal(int, int, android.view.MotionEvent):boolean");
    }

    @Override // android.view.View, android.support.p008v4.view.ScrollingView
    ...
    public void smoothScrollBy(@InterfaceC0019Px int i, @InterfaceC0019Px int i2) {
        smoothScrollBy(i, i2, null);
    }

    public void smoothScrollBy(@InterfaceC0019Px int i, @InterfaceC0019Px int i2, @Nullable Interpolator interpolator) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else if (this.mLayoutFrozen) {
    ...
    */
    protected void onAttachedToWindow() {
        ...
        L1e:
            ...
            boolean r0 = android.support.p011v7.widget.RecyclerView.ALLOW_THREAD_GAP_WORK
            if (r0 == 0) goto L69
            java.lang.ThreadLocal<android.support.v7.widget.GapWorker> r0 = android.support.p011v7.widget.GapWorker.sGapWorker
            java.lang.Object r0 = r0.get()
            android.support.v7.widget.GapWorker r0 = (android.support.p011v7.widget.GapWorker) r0
            r4.mGapWorker = r0
            ...
            r0.<init>()
            r4.mGapWorker = r0
            android.view.Display r0 = android.support.p008v4.view.ViewCompat.getDisplay(r4)
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p011v7.widget.RecyclerView.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    */
    public android.view.View findContainingItemView(@android.support.annotation.NonNull android.view.View r3) {
        ...
        L18:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p011v7.widget.RecyclerView.findContainingItemView(android.view.View):android.view.View");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    android.support.p011v7.widget.RecyclerView.ViewHolder findViewHolderForPosition(int r6, boolean r7) {
        /*
            r5 = this;
        ...
        L3a:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p011v7.widget.RecyclerView.findViewHolderForPosition(int, boolean):android.support.v7.widget.RecyclerView$ViewHolder");
    }
    ...
    public void offsetChildrenVertical(@InterfaceC0019Px int i) {
        int childCount = this.mChildHelper.getChildCount();
    ...
    public void offsetChildrenHorizontal(@InterfaceC0019Px int i) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i2 = 0; i2 < childCount; i2++) {
    ...
    public final class Recycler {
        ...
        /*
            ...
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        public android.support.p011v7.widget.RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int r17, boolean r18, long r19) {
            /*
                Method dump skipped, instructions count: 629
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p011v7.widget.RecyclerView.Recycler.tryGetViewHolderForPositionByDeadline(int, boolean, long):android.support.v7.widget.RecyclerView$ViewHolder");
        }
    ...
    public static abstract class LayoutManager {
        ...
        private final ViewBoundsCheck.Callback mHorizontalBoundCheckCallback = new ViewBoundsCheck.Callback() { // from class: android.support.v7.widget.RecyclerView.LayoutManager.1
            @Override // android.support.p011v7.widget.ViewBoundsCheck.Callback
            public int getChildCount() {
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0454R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0454R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0454R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0454R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0454R.styleable.RecyclerView_stackFromEnd, false);
            obtainStyledAttributes.recycle();
            return properties;
        }
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0454R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0454R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0454R.dimen.fastscroll_margin));
    }

    @Override // android.view.View, android.support.p008v4.view.NestedScrollingChild
    ...
    @Override // android.support.p008v4.view.NestedScrollingChild2
    ...
    public static abstract class SmoothScroller {
        ...
        protected abstract void onSeekTargetStep(@InterfaceC0019Px int i, @InterfaceC0019Px int i2, @NonNull State state, @NonNull Action action);
        ...
        public static class Action {
            ...
            public Action(@InterfaceC0019Px int i, @InterfaceC0019Px int i2) {
                this(i, i2, Integer.MIN_VALUE, null);
            }

            public Action(@InterfaceC0019Px int i, @InterfaceC0019Px int i2, int i3) {
                this(i, i2, i3, null);
            }

            public Action(@InterfaceC0019Px int i, @InterfaceC0019Px int i2, int i3, @Nullable Interpolator interpolator) {
            ...
            public void setDx(@InterfaceC0019Px int i) {
                this.mChanged = true;
                this.mDx = i;
            }
            ...
            public void setDy(@InterfaceC0019Px int i) {
                this.mChanged = true;
                this.mDy = i;
            }
            ...
            public void update(@InterfaceC0019Px int i, @InterfaceC0019Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mDx = i;
                this.mDy = i2;
                this.mDuration = i3;
                this.mInterpolator = interpolator;
    ...
    private class ItemAnimatorRestoreListener implements ItemAnimator.ItemAnimatorListener {
        ...
        @Override // android.support.p011v7.widget.RecyclerView.ItemAnimator.ItemAnimatorListener
