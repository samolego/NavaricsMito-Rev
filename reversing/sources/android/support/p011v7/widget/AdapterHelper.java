...
import android.support.p011v7.widget.OpReorderer;
    ...
    */
    public int applyPendingUpdatesToPosition(int r6) {
        ...
        L7:
            ...
            android.support.v7.widget.AdapterHelper$UpdateOp r2 = (android.support.p011v7.widget.AdapterHelper.UpdateOp) r2
            int r3 = r2.cmd
            r4 = 8
            if (r3 == r4) goto L34
            switch(r3) {
        ...
        L4a:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p011v7.widget.AdapterHelper.applyPendingUpdatesToPosition(int):int");
    }
    ...
    @Override // android.support.p011v7.widget.OpReorderer.Callback
