...
import android.support.p011v7.preference.internal.AbstractMultiSelectListPreference;
...
public abstract class PreferenceFragmentCompat extends Fragment implements DialogPreference.TargetFragment, PreferenceManager.OnDisplayPreferenceDialogListener, PreferenceManager.OnNavigateToScreenListener, PreferenceManager.OnPreferenceTreeClickListener {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        TypedArray obtainStyledAttributes = this.mStyledContext.obtainStyledAttributes(null, C0447R.styleable.PreferenceFragmentCompat, C0447R.attr.preferenceFragmentCompatStyle, 0);
        this.mLayoutResId = obtainStyledAttributes.getResourceId(C0447R.styleable.PreferenceFragmentCompat_android_layout, this.mLayoutResId);
        Drawable drawable = obtainStyledAttributes.getDrawable(C0447R.styleable.PreferenceFragmentCompat_android_divider);
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0447R.styleable.PreferenceFragmentCompat_android_dividerHeight, -1);
        boolean z = obtainStyledAttributes.getBoolean(C0447R.styleable.PreferenceFragmentCompat_allowDividerAfterLastItem, true);
    ...
    /* renamed from: android.support.v7.preference.PreferenceFragmentCompat$ScrollToPreferenceObserver */
    /* loaded from: classes.dex */
    ...
    /* renamed from: android.support.v7.preference.PreferenceFragmentCompat$DividerDecoration */
    /* loaded from: classes.dex */
