...
import android.support.p011v7.util.ThreadUtil;
import android.support.p011v7.util.TileList;
...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    /* loaded from: classes.dex */
    class C04631 implements ThreadUtil.MainThreadCallback<T> {
        ...
        private Runnable mMainThreadRunnable = new Runnable() { // from class: android.support.v7.util.MessageThreadUtil.1.1
            ...
            public void run() {
                SyncQueueItem next = C04631.this.mQueue.next();
                while (next != null) {
                    switch (next.what) {
                        case 1:
                            C04631.this.val$callback.updateItemCount(next.arg1, next.arg2);
                            break;
                        case 2:
                            C04631.this.val$callback.addTile(next.arg1, (TileList.Tile) next.data);
                            break;
                        case 3:
                            C04631.this.val$callback.removeTile(next.arg1, next.arg2);
                            break;
                        default:
                            Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                            break;
                    }
                    next = C04631.this.mQueue.next();
                }
            }
        };

        C04631(ThreadUtil.MainThreadCallback mainThreadCallback) {
            this.val$callback = mainThreadCallback;
        }

        @Override // android.support.p011v7.util.ThreadUtil.MainThreadCallback
    ...
    @Override // android.support.p011v7.util.ThreadUtil
    public ThreadUtil.MainThreadCallback<T> getMainThreadProxy(ThreadUtil.MainThreadCallback<T> mainThreadCallback) {
        return new C04631(mainThreadCallback);
    }

    /* renamed from: android.support.v7.util.MessageThreadUtil$2 */
    /* loaded from: classes.dex */
    class C04652 implements ThreadUtil.BackgroundCallback<T> {
        ...
        private Runnable mBackgroundRunnable = new Runnable() { // from class: android.support.v7.util.MessageThreadUtil.2.1
            ...
            public void run() {
                while (true) {
                    SyncQueueItem next = C04652.this.mQueue.next();
                    if (next != null) {
                        switch (next.what) {
                            case 1:
                                C04652.this.mQueue.removeMessages(1);
                                C04652.this.val$callback.refresh(next.arg1);
                                break;
                            case 2:
                                C04652.this.mQueue.removeMessages(2);
                                C04652.this.mQueue.removeMessages(3);
                                C04652.this.val$callback.updateRange(next.arg1, next.arg2, next.arg3, next.arg4, next.arg5);
                                break;
                            case 3:
                                C04652.this.val$callback.loadTile(next.arg1, next.arg2);
                                break;
                            case 4:
                                C04652.this.val$callback.recycleTile((TileList.Tile) next.data);
                                break;
                            default:
                                Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                                break;
                        ...
                        C04652.this.mBackgroundRunning.set(false);
                        return;
                    }
                }
            }
        ...
        C04652(ThreadUtil.BackgroundCallback backgroundCallback) {
            this.val$callback = backgroundCallback;
        }

        @Override // android.support.p011v7.util.ThreadUtil.BackgroundCallback
    ...
    public ThreadUtil.BackgroundCallback<T> getBackgroundProxy(ThreadUtil.BackgroundCallback<T> backgroundCallback) {
        return new C04652(backgroundCallback);
    }
