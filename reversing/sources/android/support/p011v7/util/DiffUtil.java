package android.support.p011v7.util;
...
public class DiffUtil {
    private static final Comparator<Snake> SNAKE_COMPARATOR = new Comparator<Snake>() { // from class: android.support.v7.util.DiffUtil.1
        ...
        public int compare(Snake snake, Snake snake2) {
            int i = snake.f116x - snake2.f116x;
            return i == 0 ? snake.f117y - snake2.f117y : i;
        }
    };
    ...
    public static DiffResult calculateDiff(@NonNull Callback callback, boolean z) {
        ...
        while (!arrayList2.isEmpty()) {
            ...
            if (diffPartial != null) {
                ...
                diffPartial.f116x += range.oldListStart;
                diffPartial.f117y += range.newListStart;
                Range range2 = arrayList3.isEmpty() ? new Range() : (Range) arrayList3.remove(arrayList3.size() - 1);
                range2.oldListStart = range.oldListStart;
                range2.newListStart = range.newListStart;
                if (diffPartial.reverse) {
                    range2.oldListEnd = diffPartial.f116x;
                    range2.newListEnd = diffPartial.f117y;
                } else if (diffPartial.removal) {
                    range2.oldListEnd = diffPartial.f116x - 1;
                    range2.newListEnd = diffPartial.f117y;
                } else {
                    range2.oldListEnd = diffPartial.f116x;
                    range2.newListEnd = diffPartial.f117y - 1;
                }
                arrayList2.add(range2);
                if (diffPartial.reverse) {
                    if (diffPartial.removal) {
                        range.oldListStart = diffPartial.f116x + diffPartial.size + 1;
                        range.newListStart = diffPartial.f117y + diffPartial.size;
                    } else {
                        range.oldListStart = diffPartial.f116x + diffPartial.size;
                        range.newListStart = diffPartial.f117y + diffPartial.size + 1;
                    }
                } else {
                    range.oldListStart = diffPartial.f116x + diffPartial.size;
                    range.newListStart = diffPartial.f117y + diffPartial.size;
    ...
    */
    private static android.support.p011v7.util.DiffUtil.Snake diffPartial(android.support.p011v7.util.DiffUtil.Callback r19, int r20, int r21, int r22, int r23, int[] r24, int[] r25, int r26) {
        /*
            Method dump skipped, instructions count: 313
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p011v7.util.DiffUtil.diffPartial(android.support.v7.util.DiffUtil$Callback, int, int, int, int, int[], int[], int):android.support.v7.util.DiffUtil$Snake");
    }
    ...
    public static class DiffResult {
        ...
        private void addRootSnake() {
            ...
            if (snake != null && snake.f116x == 0 && snake.f117y == 0) {
                return;
            }
        ...
        private void findMatchingItems() {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                ...
                int i3 = snake.f116x + snake.size;
                int i4 = snake.f117y + snake.size;
                ...
                for (int i5 = 0; i5 < snake.size; i5++) {
                    int i6 = snake.f116x + i5;
                    int i7 = snake.f117y + i5;
        ...
        private boolean findMatchingItem(int i, int i2, int i3, boolean z) {
            ...
            while (i3 >= 0) {
                ...
                int i7 = snake.f116x + snake.size;
                int i8 = snake.f117y + snake.size;
                if (z) {
        ...
        public void dispatchUpdatesTo(@NonNull ListUpdateCallback listUpdateCallback) {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                Snake snake = this.mSnakes.get(size);
                int i3 = snake.size;
                int i4 = snake.f116x + i3;
                int i5 = snake.f117y + i3;
                if (i4 < i) {
                ...
                for (int i6 = i3 - 1; i6 >= 0; i6--) {
                    if ((this.mOldItemStatuses[snake.f116x + i6] & 31) == 2) {
                        batchingListUpdateCallback.onChanged(snake.f116x + i6, 1, this.mCallback.getChangePayload(snake.f116x + i6, snake.f117y + i6));
                    }
                }
                i = snake.f116x;
                i2 = snake.f117y;
