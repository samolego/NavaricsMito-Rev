...
import android.support.p008v4.graphics.PathParser;
...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        this.f95mX = new float[min];
        this.f96mY = new float[min];
        ...
        if (Math.abs(this.f95mX[0]) <= 1.0E-5d && Math.abs(this.f96mY[0]) <= 1.0E-5d) {
            int i3 = min - 1;
            if (Math.abs(this.f95mX[i3] - 1.0f) <= 1.0E-5d && Math.abs(this.f96mY[i3] - 1.0f) <= 1.0E-5d) {
                int i4 = 0;
                float f = 0.0f;
                while (i < min) {
                    float[] fArr2 = this.f95mX;
                    int i5 = i4 + 1;
                    float f2 = fArr2[i4];
                    if (f2 < f) {
        ...
        sb.append(this.f95mX[0]);
        sb.append(",");
        sb.append(this.f96mY[0]);
        sb.append(" end:");
        int i6 = min - 1;
        sb.append(this.f95mX[i6]);
        sb.append(",");
        sb.append(this.f96mY[i6]);
