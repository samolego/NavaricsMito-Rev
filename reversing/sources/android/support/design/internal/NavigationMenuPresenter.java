...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    public void initForMenu(Context context, MenuBuilder menuBuilder) {
        ...
        this.paddingSeparator = context.getResources().getDimensionPixelOffset(C0062R.dimen.design_navigation_separator_vertical_padding);
    }

    @Override // android.support.p011v7.view.menu.MenuPresenter
    public MenuView getMenuView(ViewGroup viewGroup) {
        if (this.menuView == null) {
            this.menuView = (NavigationMenuView) this.layoutInflater.inflate(C0062R.layout.design_navigation_menu, viewGroup, false);
            if (this.adapter == null) {
                this.adapter = new NavigationMenuAdapter();
            }
            this.headerLayout = (LinearLayout) this.layoutInflater.inflate(C0062R.layout.design_navigation_item_header, (ViewGroup) this.menuView, false);
    ...
    public static class NormalViewHolder extends ViewHolder {
        public NormalViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup, View.OnClickListener onClickListener) {
            super(layoutInflater.inflate(C0062R.layout.design_navigation_item, viewGroup, false));
    ...
    public static class SubheaderViewHolder extends ViewHolder {
        public SubheaderViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C0062R.layout.design_navigation_item_subheader, viewGroup, false));
        }
    }
    ...
    public static class SeparatorViewHolder extends ViewHolder {
        public SeparatorViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C0062R.layout.design_navigation_item_separator, viewGroup, false));
        }
    }
