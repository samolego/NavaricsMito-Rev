package android.support.p008v4.text.util;
...
class FindAddress {
    ...
    /* renamed from: NL */
    private static final String f101NL = "\n\u000b\f\r\u0085\u2028\u2029";

    /* renamed from: SP */
    private static final String f102SP = "\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000";
    private static final String WORD_DELIM = ",*•\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000\n\u000b\f\r\u0085\u2028\u2029";
    private static final String WORD_END = "(?=[,*•\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000\n\u000b\f\r\u0085\u2028\u2029]|$)";

    /* renamed from: WS */
    private static final String f103WS = "\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000\n\u000b\f\r\u0085\u2028\u2029";
        ...
        while (true) {
            if (end < str.length()) {
                ...
                while (end < matcher.start()) {
                    int i5 = end + 1;
                    if (f101NL.indexOf(str.charAt(end)) != -1) {
                        i++;
                    }
                    end = i5;
                }
