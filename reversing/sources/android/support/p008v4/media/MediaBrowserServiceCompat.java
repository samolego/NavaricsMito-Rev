...
import android.support.p008v4.media.MediaBrowserServiceCompatApi21;
import android.support.p008v4.media.MediaBrowserServiceCompatApi23;
import android.support.p008v4.media.MediaBrowserServiceCompatApi26;
import android.support.p008v4.media.session.IMediaSession;
import android.support.p008v4.media.session.MediaSessionCompat;
import android.support.p008v4.p010os.ResultReceiver;
import android.support.p008v4.util.ArrayMap;
import android.support.p008v4.util.Pair;
...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class MediaBrowserServiceImplBase implements MediaBrowserServiceImpl {
        ...
        @Override // android.support.p008v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImpl
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl, MediaBrowserServiceCompatApi21.ServiceCompatProxy {
        ...
        @Override // android.support.p008v4.media.MediaBrowserServiceCompatApi21.ServiceCompatProxy
        ...
        public void onLoadChildren(String str, final MediaBrowserServiceCompatApi21.ResultWrapper<List<Parcel>> resultWrapper) {
            MediaBrowserServiceCompat.this.onLoadChildren(str, new Result<List<MediaBrowserCompat.MediaItem>>(str) { // from class: android.support.v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi21.2
                ...
                @Override // android.support.p008v4.media.MediaBrowserServiceCompat.Result
    ...
    class MediaBrowserServiceImplApi23 extends MediaBrowserServiceImplApi21 implements MediaBrowserServiceCompatApi23.ServiceCompatProxy {
        ...
        @Override // android.support.p008v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi21, android.support.p008v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImpl
        public void onCreate() {
            this.mServiceObj = MediaBrowserServiceCompatApi23.createService(MediaBrowserServiceCompat.this, this);
            MediaBrowserServiceCompatApi21.onCreate(this.mServiceObj);
        }

        @Override // android.support.p008v4.media.MediaBrowserServiceCompatApi23.ServiceCompatProxy
    ...
    class MediaBrowserServiceImplApi26 extends MediaBrowserServiceImplApi23 implements MediaBrowserServiceCompatApi26.ServiceCompatProxy {
        ...
        @Override // android.support.p008v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi23, android.support.p008v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi21, android.support.p008v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImpl
        public void onCreate() {
            this.mServiceObj = MediaBrowserServiceCompatApi26.createService(MediaBrowserServiceCompat.this, this);
            MediaBrowserServiceCompatApi21.onCreate(this.mServiceObj);
        }

        @Override // android.support.p008v4.media.MediaBrowserServiceCompatApi26.ServiceCompatProxy
        ...
        @Override // android.support.p008v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi21
        void notifyChildrenChangedForFramework(String str, Bundle bundle) {
            if (bundle != null) {
    ...
    private static class ServiceCallbacksCompat implements ServiceCallbacks {
        ...
        @Override // android.support.p008v4.media.MediaBrowserServiceCompat.ServiceCallbacks
