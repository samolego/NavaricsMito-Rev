...
public class FragmentActivity extends ComponentActivity implements ViewModelStoreOwner, ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    @Override // android.support.p008v4.app.ComponentActivity, android.arch.lifecycle.LifecycleOwner
    public Lifecycle getLifecycle() {
        return super.getLifecycle();
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // android.support.p008v4.app.ComponentActivity, android.app.Activity
    ...
    @Override // android.support.p008v4.app.ActivityCompat.RequestPermissionsRequestCodeValidator
    ...
    @Override // android.app.Activity, android.support.p008v4.app.ActivityCompat.OnRequestPermissionsResultCallback
    ...
    class HostCallbacks extends FragmentHostCallback<FragmentActivity> {
        ...
        @Override // android.support.p008v4.app.FragmentHostCallback
        ...
        @Override // android.support.p008v4.app.FragmentHostCallback, android.support.p008v4.app.FragmentContainer
        @Nullable
    ...
    private static boolean markState(FragmentManager fragmentManager, Lifecycle.State state) {
        ...
        for (Fragment fragment : fragmentManager.getFragments()) {
            if (fragment != null) {
                if (fragment.getLifecycle().mo12886a().isAtLeast(Lifecycle.State.STARTED)) {
                    fragment.mLifecycleRegistry.m12884a(state);
                    z = true;
                }
