...
public class Fragment implements LifecycleOwner, ViewModelStoreOwner, ComponentCallbacks, View.OnCreateContextMenuListener {
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (!this.mCalled) {
            ...
            this.mViewLifecycleRegistry.m12885a(Lifecycle.Event.ON_CREATE);
        }
    }
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachController(this.mHost, new FragmentContainer() { // from class: android.support.v4.app.Fragment.2
            @Override // android.support.p008v4.app.FragmentContainer
            @Nullable
    ...
    public void performCreate(Bundle bundle) {
        ...
        this.mLifecycleRegistry.m12885a(Lifecycle.Event.ON_CREATE);
    }
    ...
    public void performStart() {
        ...
        this.mLifecycleRegistry.m12885a(Lifecycle.Event.ON_START);
        if (this.mView != null) {
            this.mViewLifecycleRegistry.m12885a(Lifecycle.Event.ON_START);
        }
    }
    ...
    public void performResume() {
        ...
        this.mLifecycleRegistry.m12885a(Lifecycle.Event.ON_RESUME);
        if (this.mView != null) {
            this.mViewLifecycleRegistry.m12885a(Lifecycle.Event.ON_RESUME);
        }
    }
    ...
    public void performPause() {
        if (this.mView != null) {
            this.mViewLifecycleRegistry.m12885a(Lifecycle.Event.ON_PAUSE);
        }
        this.mLifecycleRegistry.m12885a(Lifecycle.Event.ON_PAUSE);
        FragmentManagerImpl fragmentManagerImpl = this.mChildFragmentManager;
        if (fragmentManagerImpl != null) {
    ...
    public void performStop() {
        if (this.mView != null) {
            this.mViewLifecycleRegistry.m12885a(Lifecycle.Event.ON_STOP);
        }
        this.mLifecycleRegistry.m12885a(Lifecycle.Event.ON_STOP);
        FragmentManagerImpl fragmentManagerImpl = this.mChildFragmentManager;
        if (fragmentManagerImpl != null) {
    ...
    public void performDestroyView() {
        if (this.mView != null) {
            this.mViewLifecycleRegistry.m12885a(Lifecycle.Event.ON_DESTROY);
        }
        FragmentManagerImpl fragmentManagerImpl = this.mChildFragmentManager;
        if (fragmentManagerImpl != null) {
    ...
    public void performDestroy() {
        this.mLifecycleRegistry.m12885a(Lifecycle.Event.ON_DESTROY);
        FragmentManagerImpl fragmentManagerImpl = this.mChildFragmentManager;
        if (fragmentManagerImpl != null) {
