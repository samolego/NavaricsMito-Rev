    ...
    */
    public static boolean isRequestPinShortcutSupported(@android.support.annotation.NonNull android.content.Context r3) {
        ...
        L13:
            ...
            int r0 = android.support.p008v4.content.ContextCompat.checkSelfPermission(r3, r0)
            r1 = 0
            if (r0 == 0) goto L1d
            return r1
        L1d:
        ...
        L50:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p008v4.content.p009pm.ShortcutManagerCompat.isRequestPinShortcutSupported(android.content.Context):boolean");
    }
