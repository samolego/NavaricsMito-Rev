...
public class ViewPager extends ViewGroup {
    ...
    public interface OnPageChangeListener {
        ...
        void onPageScrolled(int i, float f, @InterfaceC0019Px int i2);
    ...
    */
    void populate(int r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p008v4.view.ViewPager.populate(int):void");
    }
