...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends ViewGroup implements ChartInterface {
    ...
    public void onDraw(Canvas canvas) {
        if (this.mData == null) {
            if (!TextUtils.isEmpty(this.mNoDataText)) {
                ...
                canvas.drawText(this.mNoDataText, center.f2600x, center.f2601y, this.mInfoPaint);
            }
    ...
    public boolean saveToGallery(String str, String str2, String str3, Bitmap.CompressFormat compressFormat, int i) {
        ...
        if (file.exists() || file.mkdirs()) {
            switch (C11782.$SwitchMap$android$graphics$Bitmap$CompressFormat[compressFormat.ordinal()]) {
                case 1:
                    str4 = "image/png";
                    if (!str.endsWith(".png")) {
                        str = str + ".png";
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C11782 {
