...
public class SPCD_INFO {
    public SPCD_CATEGORY Category;
    ...
    public int fill(byte[] bArr, int i, byte b) {
        ...
        if (b == 0) {
            this.Category = SPCD_CATEGORY.getVal(SP_Util.byteArrayToInt(bArr, i));
            i += 4;
        } else if (b == 1) {
            this.Category = SPCD_CATEGORY.getVal(bArr[i]);
            i++;
        }
    ...
    public String toString() {
        ...
        sb.append("ManufacturerID: " + Integer.toHexString(this.ManufacturerID) + "\n");
        sb.append("ModelID: " + Integer.toHexString(this.ModelID) + "\n");
        sb.append("SerialNo: " + SP_Util.byte2str(this.SerialNo) + "\n");
        sb.append("ManufactureDate: " + this.ManufactureDate.toString() + "\n");
        sb.append("HardwareVersion: " + Integer.toHexString(this.HardwareVersion) + "\n");
        sb.append("FirmwareVersion: " + Integer.toHexString(this.FirmwareVersion) + "\n");
