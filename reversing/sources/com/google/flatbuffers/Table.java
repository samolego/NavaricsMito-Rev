...
public class Table {
    ...
    protected int __offset(int i) {
        int i2 = this.bb_pos;
        int i3 = i2 - this.f3412bb.getInt(i2);
        if (i < this.f3412bb.getShort(i3)) {
            return this.f3412bb.getShort(i3 + i);
        }
        return 0;
    }
    ...
    protected int __indirect(int i) {
        return i + this.f3412bb.getInt(i);
    }
    ...
    protected String __string(int i) {
        ...
        int i2 = i + this.f3412bb.getInt(i);
        ByteBuffer order = this.f3412bb.duplicate().order(ByteOrder.LITTLE_ENDIAN);
    ...
    protected int __vector_len(int i) {
        ...
        return this.f3412bb.getInt(i2 + this.f3412bb.getInt(i2));
    }

    protected int __vector(int i) {
        int i2 = i + this.bb_pos;
        return i2 + this.f3412bb.getInt(i2) + 4;
    }
    ...
    protected Table __union(Table table, int i) {
        int i2 = i + this.bb_pos;
        table.bb_pos = i2 + this.f3412bb.getInt(i2);
        table.f3412bb = this.f3412bb;
        return table;
    }
