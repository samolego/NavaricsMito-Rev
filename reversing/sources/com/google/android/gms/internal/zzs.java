...
public class zzs {
    ...
    public static class zza {
        ...
        private final List<C3255zza> zzbk = new ArrayList();
        ...
        /* loaded from: classes.dex */
        public static class C3255zza {
            public final String name;
            public final long time;
            public final long zzbm;

            public C3255zza(String str, long j, long j2) {
                this.name = str;
                this.zzbm = j;
                this.time = j2;
            }
        ...
        public synchronized void zza(String str, long j) {
            ...
            this.zzbk.add(new C3255zza(str, j, SystemClock.elapsedRealtime()));
        }
        ...
        public synchronized void zzd(String str) {
            ...
            for (C3255zza c3255zza : this.zzbk) {
                long j2 = c3255zza.time;
                zzs.zzb("(+%-4d) [%2d] %s", Long.valueOf(j2 - j), Long.valueOf(c3255zza.zzbm), c3255zza.name);
                j = j2;
            }
        }
    }
