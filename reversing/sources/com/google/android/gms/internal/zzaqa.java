...
public class zzaqa implements Closeable, Flushable {
    ...
    /* renamed from: bM */
    private void m9623bM() throws IOException {
        if (this.boy != null) {
            m9621bO();
            zzuw(this.boy);
            this.boy = null;
    ...
    /* renamed from: bN */
    private void m9622bN() throws IOException {
        if (this.box == null) {
            return;
        }
        this.out.write("\n");
    ...
    /* renamed from: bO */
    private void m9621bO() throws IOException {
        int m9624bL = m9624bL();
        if (m9624bL == 5) {
            this.out.write(44);
        } else if (m9624bL != 3) {
    ...
    */
    ...
    /* renamed from: bJ */
    public final boolean m9626bJ() {
        return this.bkO;
    }

    /* renamed from: bK */
    public final boolean m9625bK() {
        return this.bkN;
    }
