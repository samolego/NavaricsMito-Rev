...
/* renamed from: com.navatics.app.framework.b.o */
/* loaded from: classes.dex */
public class GroundStationAuthSuccessValidator implements EventHandlerValidator {

    /* renamed from: a */
    private final C3044k f4280a = C3044k.m1564a(GroundStationAuthSuccessValidator.class);
    ...
    public EventPipeline.C1751a mo8569a(Object obj, Method method) {
        ...
        if (parameterTypes.length != 1) {
            C3044k c3044k = this.f4280a;
            c3044k.mo1504b((Object) ("Event GNDSTA_AUTH_SUCCESS need 1 parameter, but we got " + parameterTypes.length));
            return null;
        }
        Class<?> cls = parameterTypes[0];
        if (cls != GroundStation.class) {
            C3044k c3044k2 = this.f4280a;
            c3044k2.mo1504b((Object) ("Event GNDSTA_AUTH_SUCCESS first parameter expect GroundStation, but we got " + cls.getCanonicalName()));
            return null;
        }
        return new EventPipeline.C1751a(obj, method, 65546, 0);
    }
}
